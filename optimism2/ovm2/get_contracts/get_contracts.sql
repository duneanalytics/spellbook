...
CREATE INDEX IF NOT EXISTS ovm2_get_contracts_contract_address_contract_project_created_time_destruct_idx ON ovm2.get_contracts (contract_address,contract_project,created_time,is_self_destruct);
