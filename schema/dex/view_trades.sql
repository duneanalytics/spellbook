...
FROM (
    ...
    SELECT
        ...
        CASE
            WHEN "addressSet"->'quoteAsset'::TEXT = '"0x000000000000000000000000000000000000000e"' THEN '\xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
            ELSE decode(substring(("addressSet"->'quoteAsset')::TEXT, 4,40), 'hex')
        END AS token_a_address,
        CASE
            WHEN "addressSet"->'baseAsset'::TEXT = '"0x000000000000000000000000000000000000000e"' THEN '\xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
