CREATE OR REPLACE VIEW compound_v2.view_ctokens (symbol, contract_address, decimals, underlying_token_address) AS VALUES
...
('cETH'::text, '\x4ddc2d193948926d02f9b1fe9e1daa0718270ed5'::bytea, 8::numeric, '\xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'::bytea), -- note: using weth contract address here for convenience
