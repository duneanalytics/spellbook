CREATE OR REPLACE VIEW bancor.view_convert_with_fee AS
SELECT "fromToken" AS source_token_address,
       ...
       "conversionFee" / 10^t2.decimals AS conversion_fee,
       s.contract_address,
       s.evt_tx_hash AS tx_hash,
       s.evt_block_time AS block_time
FROM bancor."BancorConverterWithFee_evt_Conversion" s
