CREATE OR REPLACE VIEW bancor.view_legacy_convert AS
SELECT "fromToken" AS source_token_address,
       ...
       "_currentPriceN" AS current_price_n,
       "_currentPriceD" AS current_price_d,
       s.contract_address,
       s.evt_tx_hash AS tx_hash,
       s.evt_block_time AS block_time
FROM bancor."BancorLegacyConverter_evt_Conversion" s
