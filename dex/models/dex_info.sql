...
FROM (VALUES
    ...
    , ('uwulend', 'UwU Lend', 'Lending', 'UwU_Lend')
    , ('agave', 'Agave', 'Lending', 'Agave_lending')
    , ('granary', 'Granary Finance', 'Lending', 'GranaryFinance')
    , ('spark', 'Spark', 'Lending', 'sparkdotfi')
    , ('radiant', 'Radiant Capital', 'Lending', 'RDNTCapital')
    , ('moola', 'Moola Market', 'Lending', 'moola_market')
