...
WITH pool_labels AS (
    ...
    dex_prices_1 AS (
        ...
        ('{{blockchain}}' = 'fantom' AND contract_address NOT IN (0xde1e704dae0b4051e80dabb26ab6ad6c12262da0, 0x5ddb92a5340fd0ead3987d3661afcd6104c3b757))
        OR '{{blockchain}}' = 'fantom' AND contract_address NOT IN (0x039e2fb66102314ce7b64ce5ce3e5183bc94ad38)) --broken price feeds
