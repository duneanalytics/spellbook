...
SELECT dex.insert_trades(
    ...
    '2021-07-01',
    (SELECT max(number) FROM xdai.blocks WHERE time <= '2021-01-01'),
    (SELECT max(number) FROM xdai.blocks WHERE time <= '2021-07-01'))
WHERE NOT EXISTS (SELECT * FROM dex.trades WHERE block_time > '2021-01-01' AND block_time <= '2021-07-01' LIMIT 1);
...
WHERE NOT EXISTS (SELECT * FROM dex.trades WHERE block_time > '2021-07-01' AND block_time <= '2022-01-01' LIMIT 1);
