...
FROM (values
    --  (0x9fFD84fA80932Fa55E761B06398aA2577815c459,'Admin & Gas Fee') --ignore
     (0xf42279467D821bCDf40b50E9A5d2cACCc4Cf5b30, from_hex({{op_token}}), 'Quest 1 - DEX')
    ,(0x9F4F2B8BdA8D2d3832021b3119747470ea86A183, from_hex({{op_token}}), 'Quest 2 - Delegation')
    ,(0x1fe95e0497a0E38AFBE18Bd19B9a2b42116880f0, from_hex({{op_token}}), 'Quest 3 - Attestation')
    ,(0x12d9aEF514EE8Bc3f7B2d523ae26164632b71acB, from_hex({{op_token}}), 'Quest 4 - Deposit')
    ,(0x0b1cef4cab511426b001f430b8d000d5a8c83ad0, from_hex({{op_token}}), 'Quest 5 - NFT Mint')
