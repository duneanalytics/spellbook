        ...
        from
          (
            VALUES
              ...
              , (
                '0x2E05A304d3040f1399c8C20D2a9F659AE7521058'
                , 'https://www.luno.com/'
              )
              , (
              ...
              , (
                ...
                , 'https://indodax.com/ exchange'
              )
              , (
                '0xFDeda15e2922C5ed41fc1fdF36DA2FB2623666b3'
                , 'HitBTC: Deposit Funder '
              )
              , (
              ...
              , (
                ...
                , 'https://www.acron, ‘.com/en-us/'
              )
              , (
                '0x734ac651dd95a339c633cded410228515f97faff'
                , 'ZB.com: Deposit Funder'
              )
              , (
                '0xc00eebe4e2be29679781fc5fc350057ee8132bab'
                , 'LAToken Wallet'
              )
              , (
              ...
              , (
                ...
                , 'changenow: gas supplier'
              )
              , (
                '0xcDd37Ada79F589c15bD4f8fD2083dc88E34A2af2'
                , 'SideShift: Hot Wallet'
              )
              , (
              ...
              , (
                '0xf646cbe3b030fb6c2569215f0117dba58badb95e'
                , 'Bitbay'
              )
              , (
                '0x32B56FC48684FA085dF8C4cd2feAAfC25c304dB9'
                , 'related to korbit exchange'
              )
              , (
              ...
              , (
                '0x777f415324d56e1d54fa832902d8797db7a4c57c'
                , '1xbet '
              )
              , (
              ...
              , (
                '0x09344477fdc71748216a7b8bbe7f2013b893def8'
                , 'ascendex deposit address'
              )
              , (
              ...
              , (
                ...
                , 'changenow binance deposit address'
              )
              , (
              ...
              , (
                '0xeea5e6ea5998928352cf54425819436f80f95ae9'
                , 'EXMO deployer'
              )
              , (
              ...
              , (
                '0x8365efb25d0822aaf15ee1d314147b6a7831c403'
                , 'Remitano: Deposit Funder'
              )
              , (
                '0x1a1c87d9a6f55d3bbb064bff1059ad37b6bdc097'
                , 'Bitvavo gas supplier'
              )
              , (
              ...
              , (
                '0x6c3F07bfDfce0463457385129fed97F0992a111d'
                , 'Poloniex exchange deployer'
              )
              , (
              ...
              , (
                ...
                , 'Coinspot gas supplir'
              )
              , (
                '0x73f9b272abda7a97cb1b237d85f9a7236edb6f16'
                , 'Binance Deposit'
              )
  ...
  SELECT
    ...
    , case
      when
        ...
        and sum(amount_usd) < cast(100000 as double)
      then 'Turtle trader'
      when
        sum(amount_usd) >= cast(100000 as double)
        and sum(amount_usd) < cast(500000 as double)
      then 'Shark trader'
...
, Former_traders as (
  SELECT
    ...
    , case
      when
        ...
        and t.monthly_trade_amount < cast(100000 as double)
      then 'Former Turtle trader'
      when
        t.monthly_trade_amount >= cast(100000 as double)
        and t.monthly_trade_amount < cast(500000 as double)
      then 'Former Shark trader'
      when
        t.monthly_trade_amount >= cast(500000 as double)
  ...
  FROM
    (
      ...
      left join active_traders t2
      on t1.tx_from = t2.tx_from
      where
      ...
      GROUP BY
        ...
        , 2
      HAVING
        sum(t1.amount_usd) > cast(10000 as double)
    ) t
  WHERE
    t.rn = 1
  ORDER BY
    t.month
    , t.monthly_trade_amount DESC
)
, final as (
  SELECT
