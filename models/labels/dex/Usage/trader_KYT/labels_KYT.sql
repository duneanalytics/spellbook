...
distinct "from"
from(
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('ethereum.transactions') }}  group by 1,2 
having count(*) > 1000
union all 
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('polygon.transactions') }}  group by 1,2 
having count(*) > 1000
union all
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('optimism.transactions') }}  group by 1,2 
having count(*) > 1000
union all
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('arbitrum.transactions') }}  group by 1,2 
having count(*) > 1000
union all
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('gnosis.transactions') }}  group by 1,2 
having count(*) > 1000
union all
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('fantom.transactions') }}  group by 1,2 
having count(*) > 1000
union all
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('bnb.transactions') }}  group by 1,2 
having count(*) > 1000
union all
select "from", date_trunc('month', block_time) as month, count(*) as num_tx from {{ ref('avalanche_c.transactions') }} group by 1,2 
having count(*) > 1000
))
