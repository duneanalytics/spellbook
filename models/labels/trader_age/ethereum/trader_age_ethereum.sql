...
select
  ...
  address,
  case
    when trader_age > 1825 then '5 years'
    when trader_age > 1460 then '4 years'
    when trader_age > 1095 then '3 years'
    when trader_age > 730 then '2 years'
    when trader_age > 365 then '1 year'
