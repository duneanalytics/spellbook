...
FROM (VALUES
    ...
    , (array('ethereum'), '0xcd9d4988c0ae61887b075ba77f08cbfad2b65068', 'Synthetix: L2 Deposit', 'bridge', 'msilb7', 'static', timestamp('2022-10-12'), now())
    , (array('ethereum'), '0x5fd79d46eba7f351fe49bff9e87cdea6c821ef9f', 'Synthetix: L2 Deposit Escrow', 'bridge', 'msilb7', 'static', timestamp('2022-10-12'), now())
    ...
    , (array('ethereum'), '0xc51f137e19f1ae6944887388fd12b2b6dfd12594', 'Synthetix: Legacy Optimism Bridge', 'bridge', 'msilb7', 'static', timestamp('2022-10-12'), now())
    ...
    , (array('ethereum'), '0x045e507925d2e05d114534d0810a1abd94aca8d6', 'Synthetix: Legacy L2 Bridge', 'bridge', 'msilb7', 'static', timestamp('2022-10-12'), now())
