...
FROM (VALUES
    -- Source: https://ftmscan.com/accounts/label/bridge
        (array('fantom'), '0xbbbd1bbb4f9b936c3604906d7592a644071de884', 'Allbridge: Bridge', 'bridge', 'Henrystats', 'static', timestamp('2023-01-27'), now())
    , (array('fantom'), '0x374b8a9f3ec5eb2d97eca84ea27aca45aa1c57ef', 'Celer Network: cBridge', 'bridge', 'Henrystats', 'static', timestamp('2023-01-27'), now())
    , (array('fantom'), '0x3795c36e7d12a8c252a20c5a7b455f7c57b60283', 'Celer Network: cBridge 2', 'bridge', 'Henrystats', 'static', timestamp('2023-01-27'), now())
    , (array('fantom'), '0x43de2d77bf8027e25dbd179b491e8d64f38398aa', 'deBridgeGate', 'bridge', 'Henrystats', 'static', timestamp('2023-01-27'), now())
    , (array('fantom'), '0x7ab4c5738e39e613186affd4c50dbfdff6c22065', 'DEUS Finance: Bridge', 'bridge', 'Henrystats', 'static', timestamp('2023-01-27'), now())
