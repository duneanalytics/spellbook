...
FROM (VALUES
    ...
    ('polygon', 0x82a079DE7D2a8b59Bc932Df079eF5aA31B01AEB6, 'MacaronSwap: Bridge', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0x3c2269811836af69497E5F486A85D7316753cf62, 'Mayan: Swap Bridge', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0x99783B38eC79ff29234748b42c82Dc27A434a096, 'Multichain: anyCall V6', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0xac0Cb30cFB91dd2Cbb7C12FbfC069b3f2332AD16, 'Multichain: Fantom Bridge', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0x05B70Fb5477A93bE33822bfB31fDAF2c171970dF, 'Multichain: Router V4', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0x25864a712C80d33Ba1ad7c23CffA18b46F2fc00c, 'Multichain: Router V4 2', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ...
    ('polygon', 0x25864a712C80d33Ba1ad7c23CffA18b46F2fc00c, 'Rubic Exchange', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0x6fF0609046A38D76Bd40C5863b4D1a2dCe687f73, 'Synapse: Bridge', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0x3a5846882C0d5F8B0FA4bB04dc90C013104d125d, 'Synapse: Bridge Zap 1', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
    ('polygon', 0xa489b8981ae5652C9Dd6515848cB8Dbecae5E1B0, 'Wormhole: NFT Bridge', 'bridge', 'rantum', 'static', DATE '2023-11-15', now(), 'bridges_polygon', 'identifier'),
