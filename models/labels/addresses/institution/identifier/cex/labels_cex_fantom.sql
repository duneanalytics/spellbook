{{config(tags=['dunesql'],alias = alias('cex_fantom'),
...
FROM (VALUES
    ...
    ('fantom', 0x8e1701cfd85258ddb8dfe89bc4c7350822b9601d, 'MEXC: Hot Wallet', 'institution', 'Henrystats', 'static', DATE '2023-01-27' , now(), 'cex_fantom', 'identifier')
