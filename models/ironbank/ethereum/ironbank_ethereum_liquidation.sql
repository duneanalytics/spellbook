...
SELECT
    ...
    LEFT JOIN (SELECT contract_address as collateral_contract_address, 
                ...
                FROM ironbank_ethereum.itokens) i_collateral ON i."cTokenCollateral" = i_collateral.collateral_contract_address
    LEFT JOIN (SELECT contract_address as asset_contract_address, 
                        underlying_token_address as asset_underlying_token_address
                FROM ironbank_ethereum.itokens) i_asset ON i.contract_address = i_asset.asset_contract_address