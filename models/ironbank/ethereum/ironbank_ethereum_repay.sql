...
FROM {{ source('ironbank_ethereum', 'CErc20Delegator_evt_RepayBorrow') }} repay
LEFT JOIN {{ ref('ironbank_ethereum_itokens') }} itokens ON itokens.contract_address = repay.contract_address
