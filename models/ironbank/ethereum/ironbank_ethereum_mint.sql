...
FROM {{ source('ironbank_ethereum', 'CErc20Delegator_evt_Mint') }} mint
LEFT JOIN {{ ref('ironbank_ethereum_itokens') }} itokens ON mint.contract_address = itokens.contract_address
