...
, lr.trade_category
, 'Trade' AS evt_type
, CASE WHEN lr.seller=agg.contract_address THEN et.from ELSE lr.seller AS seller
, CASE WHEN lr.buyer=agg.contract_address THEN et.from ELSE lr.buyer AS buyer
