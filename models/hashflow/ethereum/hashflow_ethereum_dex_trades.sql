...
with hashflow_trades as (
    select *
    from {{ ref('hashflow_ethereum_trades') }}
...
select
    ...
    hashflow_trades.maker_token_amount * power(10, erc20a.decimals) as token_bought_amount_raw,
    hashflow_trades.taker_token_amount * power(10, erc20b.decimals) as token_sold_amount_raw,
