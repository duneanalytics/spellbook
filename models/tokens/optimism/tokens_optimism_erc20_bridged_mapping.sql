...
FROM (
        ...
        SELECT _l1Token, _l2Token, NULL AS symbol, NULL AS decimals FROM optimism_ethereum.L1StandardBridge_evt_ERC20DepositInitiated 
        {% if is_incremental() %}
        ...
        UNION ALL SELECT '0x6b175474e89094c44da98b954eedeac495271d0f' AS l1_token,'0xda10009cbd5d07dd0cecc66161fc93d7c9000da1' AS l2_token -- DAI
        UNION ALL SELECT '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' AS l1_token, '0x4200000000000000000000000000000000000006' AS l2_token --WETH
