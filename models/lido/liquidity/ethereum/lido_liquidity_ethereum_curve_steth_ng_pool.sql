...
where 
    ...
    to = 0x21e27a5e5513d6e65c4f830167390997aa84843a and
...
where 
    contract_address = 0xae7ab96520de3a18e5e111b5eaab095312d7fe84 and 
    "from" = 0x21e27a5e5513d6e65c4f830167390997aa84843a and
    DATE_TRUNC('day', evt_block_time) >=  date '{{ project_start_date }}'
...
FROM (
    ...
    WHERE "from" = 0x21e27a5e5513d6e65c4f830167390997aa84843a
    AND success
    AND (call_type NOT IN ('delegatecall', 'callcode', 'staticcall') OR call_type IS null)
    AND DATE_TRUNC('day', block_time) >= date '{{ project_start_date }}'
    ...
    WHERE to = 0x21e27a5e5513d6e65c4f830167390997aa84843a
    AND success
    AND (call_type NOT IN ('delegatecall', 'callcode', 'staticcall') OR call_type IS null)
    AND DATE_TRUNC('day', block_time) >= date '{{ project_start_date }}'
...
select 'ethereum curve ETH:stETH NG 0.04' as pool_name, 
        ...
        cast(d.day as date) as time, 0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84 as main_token, 
