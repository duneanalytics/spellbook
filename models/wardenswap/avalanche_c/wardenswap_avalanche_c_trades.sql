...
{% set project_start_date = '2022-01-03' %}     -- select min(evt_block_time) from wardenswap_bnb.BiswapPair_evt_Swap
...
SELECT 'avalanche_c'                                                           AS blockchain,
       ...
       biswap_dex.token_bought_amount_raw,
       biswap_dex.token_sold_amount_raw,
       coalesce(
