...
{% set project_start_date = '2022-04-22' %}
...
WITH dex AS (
    SELECT  t.evt_block_time AS block_time,
            ...
            '' AS trace_address,
            t.evt_index
    FROM {{ source('wardenswap_arbitrum', 'WardenPair_evt_Swap') }} t
    INNER JOIN {{ source('wardenswap_arbitrum', 'WardenFactory_evt_PairCreated') }} p
