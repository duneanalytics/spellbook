...
{% set project_start_date = '2022-02-25' %}
...
WITH dex AS (
    SELECT  t.evt_block_time AS block_time,
            ...
            '' AS trace_address,
            t.evt_index
    FROM {{ source('wardenswap_ethereum', 'WardenPair_evt_Swap') }} t
    INNER JOIN {{ source('wardenswap_ethereum', 'WardenFactory_evt_PairCreated') }} p
