...
{% set project_start_date = '2022-02-08' %}
...
WITH dex AS (
    SELECT  t.evt_block_time AS block_time,
            ...
            '' AS trace_address,
            t.evt_index
    FROM {{ source('wardenswap_polygon', 'WardenPair_evt_Swap') }} t
    INNER JOIN {{ source('wardenswap_polygon', 'WardenFactory_evt_PairCreated') }} p
