{{ config(
    ...
    alias = alias('options_close_position'),
...
get_positions_contract as (
    ...
    SELECT 
        ...
        t.evt_tx_hash,
        t.evt_index,
        CASE WHEN t.evt_tx_hash = 0xf0a5193fc41599987645f183ae0c3a8311da02ebc9e4ee136edcfd4916133e78 THEN CAST(evt_index as double) ELSE -1 END as evt_join_index,
        t.id as position_id,
