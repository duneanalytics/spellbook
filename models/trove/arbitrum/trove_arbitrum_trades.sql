...
select
    ...
    cast(prices.price * amount_raw / power(10, erc20.decimals) as decimal(38,0)) as amount_usd,
    ...
    seller,
    buyer,
    cast(amount_raw / power(10, erc20.decimals) as decimal(38,0)) as amount_original,
    amount_raw,
