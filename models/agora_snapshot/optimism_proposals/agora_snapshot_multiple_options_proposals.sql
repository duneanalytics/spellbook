-- Note: To display multiple options status of particular proposals, we have requested the 'decode' table from Dune. Once it is available, we will add detailed information of multiple option proposals in Spellbook.
