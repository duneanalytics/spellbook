...
methods as (
    ...
    from (
        ...
        , (0x12aa3caf, 'AR', true, 'swap', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0xf88309d7, 'AR', true, 'swap', map_from_entries(array[('source', 'tx-from')]), array[0xf3ae, 0x6781, 0xf4a1, 0xa48b])
        , (0xe449022e, 'AR', true, 'uniswapV3Swap', map_from_entries(array[('source', 'tx-from')]), array[0xd199, 0x0582, 0xbc2f, 0x097d])
        , (0xbc80f1a8, 'AR', true, 'uniswapV3SwapTo', map_from_entries(array[('source', 'tx-from')]), array[0xd199, 0x0582, 0xbc2f, 0x097d])
        , (0x2521b930, 'AR', true, 'uniswapV3SwapToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0xd199, 0x0582, 0xbc2f, 0x097d])
        , (0x2e95b6c8, 'AR', true, 'unoswap', map_from_entries(array[('source', 'tx-from')]), array[0xaa26, 0x097d, 0xf3ae, 0xf4a1, 0xd199])
        , (0x0502b1c5, 'AR', true, 'unoswap', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0xf78dc253, 'AR', true, 'unoswapTo', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0x3c15fd91, 'AR', true, 'unoswapToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0xa1251d75, 'AR', true, 'unoswapWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0xd199, 0x097d, 0xaa26])
        , (0x84bd6d29, 'LOP', true, 'clipperSwap', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0xb0431182, 'LOP', true, 'clipperSwap', map_from_entries(array[('source', 'tx-from')]), array[0x097d, 0xd199])
        , (0x093d4fa5, 'LOP', true, 'clipperSwapTo', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0x9994dd15, 'LOP', true, 'clipperSwapTo', map_from_entries(array[('source', 'tx-from')]), array[0x097d, 0xd199])
        , (0xc805a666, 'LOP', true, 'clipperSwapToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        ...
        , (0x62e238bb, 'LOP', true, 'fillOrder', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0xf3432b1a, 'LOP', true, 'fillOrder', map_from_entries(array[('source', 'tx-from')]), array[0xe782, 0x6857, 0x8afe, 0x84eb])
        , (0x3eca9c0a, 'LOP', true, 'fillOrderRFQ', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        ...
        , (0x9570eeee, 'LOP', true, 'fillOrderRFQCompact', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0x5a099843, 'LOP', true, 'fillOrderRFQTo', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        ...
        , (0x70ccbd31, 'LOP', true, 'fillOrderRFQToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        ...
        , (0xe5d7bde6, 'LOP', true, 'fillOrderTo', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
        , (0xd365c695, 'LOP', true, 'fillOrderToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x0582, 0xbc2f])
