...
with
    ...
    methods as (
        ...
        from (values
            ...
            , (0x7c025200, 'AR', true, 'swap', map_from_entries(array[('source', 'tx-from')]), array[0xaa26, 0xd199, 0x097d])
            , (0x90411a32, 'AR', true, 'swap', map_from_entries(array[('source', 'tx-from')]), array[0xf3ae, 0xf4a1])
            , (0x12aa3caf, 'AR', true, 'swap', map_from_entries(array[('source', 'tx-from')]), array[0x0582])
            , (0xf88309d7, 'AR', true, 'swap', map_from_entries(array[('source', 'tx-from')]), array[0x6781, 0xa48b])
            ...
            , (0x2e95b6c8, 'AR', true, 'unoswap', map_from_entries(array[('source', 'tx-from')]), array[0xaa26, 0x097d, 0xd199])
            ...
            , (0xa1251d75, 'AR', true, 'unoswapWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0xaa26, 0x097d])
            ...
            , (0xd0a3b665, 'LOP', true, 'fillOrderRFQ', map_from_entries(array[('source', 'tx-from')]), array[0x097d, 0xd199, 0x2828])
            , (0x74785238, 'LOP', true, 'fillOrderRFQ', map_from_entries(array[('source', 'tx-from')]), array[0xe782, 0x6857, 0x84eb])
            ...
            , (0xbaba5855, 'LOP', true, 'fillOrderRFQTo', map_from_entries(array[('source', 'tx-from')]), array[0x097d, 0xd199])
            , (0x70ccbd31, 'LOP', true, 'fillOrderRFQToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x0582])
            , (0x4cc4a27b, 'LOP', true, 'fillOrderRFQToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x097d, 0xd199])
            ...
            , (0x6073cc20, 'LOP', true, 'fillOrderToWithPermit', map_from_entries(array[('source', 'tx-from')]), array[0x2828, 0x6362, 0x690f, 0xf2b9, 0x734f])
