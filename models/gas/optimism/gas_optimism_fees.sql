...
SELECT 
     ...
     (COALESCE(b.base_fee_per_gas,t.gas_price)*gas_used)/1e18 AS l2_base_fee_native, --use gas price pre-Bedrock (no base fee)
     p.price * (COALESCE(b.base_fee_per_gas,t.gas_price)*gas_used)/1e18 AS l2_base_fee_usd,
