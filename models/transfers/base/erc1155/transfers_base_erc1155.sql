...
sent_transfers as (
    ...
    from {{ source('erc1155_base', 'evt_transfersingle') }}
    where 1=1
...
select 'base' as blockchain, transfer_type, wallet_address, token_address, block_month, block_time, token_id, amount, tx_hash
from sent_transfers
union
select 'base' as blockchain, transfer_type, wallet_address, token_address, block_month, block_time, token_id, amount, tx_hash
