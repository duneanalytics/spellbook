...
INNER JOIN {{ source('ethereum', 'transactions') }} tx
    ...
    {% endif %}
LEFT JOIN {{ source('tokens_ethereum', 'erc20', True) }} erc20a ON erc20a.contract_address = dexs.token_bought_address
LEFT JOIN {{ source('tokens_ethereum', 'erc20', True) }} erc20b ON erc20b.contract_address = dexs.token_sold_address
