...
WITH all_labels AS (
    SELECT
        address
        , label
        , proposal_name, address_descriptor, project_name
    ...
    SELECT
        ...
        , 'Utility' as label, 'Utility Contract' AS proposal_name
        , override_name AS address_descriptor, contract_name AS project_name
    ...
    SELECT
        address
        , 'CEX' as label, distinct_name AS proposal_name
        , cex_name AS address_descriptor, cex_name AS project_name
