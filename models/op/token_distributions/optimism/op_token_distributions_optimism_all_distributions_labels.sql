...
WITH all_labels AS (
    ...
    UNION ALL
    SELECT address, label, 'Utility Contract' AS proposal_name, address_descriptor, address_descriptor AS project_name FROM {{ ref('op_token_distributions_optimism_disperse_contracts') }}
    UNION ALL
