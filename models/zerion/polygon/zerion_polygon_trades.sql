...
WITH zerion_trades AS (
    ...
    , CASE WHEN swap.inputToken='0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' THEN '0x0000000000000000000000000000000000001010'
        ELSE swap.inputToken
        END AS token_sold_address
    , CASE WHEN swap.inputToken='0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' THEN 'MATIC'
    ...
    , CASE WHEN swap.outputToken='0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' THEN '0x0000000000000000000000000000000000001010'
        ELSE swap.outputToken
        END AS token_bought_address
    , CASE WHEN swap.outputToken='0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' THEN 'MATIC'
    ...
    LEFT JOIN {{ ref('tokens_polygon_erc20') }} tok_sold ON tok_sold.contract_address=swap.inputToken
    LEFT JOIN {{ ref('tokens_polygon_erc20') }} tok_bought ON tok_bought.contract_address=swap.outputToken
