...
{% set base_models_to_union = [
                                'usage_summary_optimism_daily_transactions_2021'
                              , 'usage_summary_optimism_daily_transactions_2022'
                              ] %}

{% set incremental_model_to_include = 'usage_summary_optimism_daily_transactions_incremental' %}
