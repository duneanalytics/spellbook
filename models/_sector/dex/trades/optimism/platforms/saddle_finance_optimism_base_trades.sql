...
{% set saddle_finance_optimism_evt_trade_tables = [
    source('saddle_finance_optimism', 'MetaSwap_evt_TokenSwap')
] %}

with dexs AS (
    {% for evt_trade_table in saddle_finance_optimism_evt_trade_tables %}
        SELECT
