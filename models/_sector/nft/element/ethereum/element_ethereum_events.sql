...
, et.from AS tx_from
, et.to AS tx_to
, eth_nft_trades.platform_fee_amount_raw
, eth_nft_trades.platform_fee_amount
, eth_nft_trades.platform_fee_amount_usd
, eth_nft_trades.platform_fee_percentage
, eth_nft_trades.royalty_fee_amount_raw
, eth_nft_trades.royalty_fee_amount
, eth_nft_trades.royalty_fee_amount_usd
, eth_nft_trades.royalty_fee_percentage
, eth_nft_trades.royalty_fee_receive_address
, eth_nft_trades.royalty_fee_currency_symbol
...
LEFT JOIN {{ ref('nft_trades') }} eth_nft_trades ON alet.nft_contract_address=eth_nft_trades.nft_contract_address AND eth_nft_trades.blockchain='ethereum'
