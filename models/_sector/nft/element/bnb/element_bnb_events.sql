...
, bt.from AS tx_from
, bt.to AS tx_to
, bnb_nft_trades.platform_fee_amount_raw
, bnb_nft_trades.platform_fee_amount
, bnb_nft_trades.platform_fee_amount_usd
, bnb_nft_trades.platform_fee_percentage
, bnb_nft_trades.royalty_fee_amount_raw
, bnb_nft_trades.royalty_fee_amount
, bnb_nft_trades.royalty_fee_amount_usd
, bnb_nft_trades.royalty_fee_percentage
, bnb_nft_trades.royalty_fee_receive_address
, bnb_nft_trades.royalty_fee_currency_symbol
...
LEFT JOIN {{ ref('nft_trades') }} bnb_nft_trades ON alet.nft_contract_address=bnb_nft_trades.nft_contract_address AND bnb_nft_trades.blockchain='bnb'
