...
SELECT
    ...
    coalesce(a.amount_raw * double '0.03',cast(0 as uint256)) as platform_fee_amount_raw,
    CAST(coalesce(a.amount_raw * double '0.03',cast(0 as uint256)) / power(10, erc.decimals) AS double) AS platform_fee_amount,
