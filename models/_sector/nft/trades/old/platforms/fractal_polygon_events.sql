...
SELECT
    ...
    coalesce(a.amount_raw,cast(0 as uint256)) / power(10, erc.decimals) * p.price AS amount_usd,
    coalesce(a.amount_raw,cast(0 as uint256)) / power(10, erc.decimals) AS amount_original,
    coalesce(a.amount_raw,cast(0 as uint256)) as amount_raw,
    ...
    coalesce(cast(a.amount_raw * double '0.03' as uint256), cast(0 as uint256)) as platform_fee_amount_raw,
    CAST(coalesce(a.amount_raw * double '0.03',cast(0 as double)) / power(10, erc.decimals) AS double) AS platform_fee_amount,
    CAST(coalesce(a.amount_raw * double '0.03',cast(0 as double)) / power(10, erc.decimals) * p.price AS double) AS platform_fee_amount_usd,
    CAST(coalesce(a.amount_raw * double '0.03',cast(0 as double))  / a.amount_raw * 100 as double) as platform_fee_percentage,
