...
,final as (
    select
        ...
        ,'quix' as project
        ,'v1' as version
        ,cast(date_trunc('month', er.block_time) as date) AS block_date
        ,er.block_time
        ,er.token_id
        ...
        ,cast(er.amount_raw as uint256) as amount_raw
        ,case
        ...
        ,cast(tr.value / er.amount_raw * 100 as double) as royalty_fee_percentage
