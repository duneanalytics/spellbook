...
LEFT JOIN {{ source('tokens', 'erc20', True) }} ava_erc20_tokens ON ava_erc20_tokens.contract_address=alet.currency_contract AND ava_erc20_tokens.blockchain='avalanche_c'
