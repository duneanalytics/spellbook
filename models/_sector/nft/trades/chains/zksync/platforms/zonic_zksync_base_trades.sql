...
with events_raw as (
    select
       ...
       ,saleId as sale_id
    from {{ source('zonic_zksync', 'ZonicMarketplace_evt_ZonicBasicOrderFulfilled') }} as o
...
,transfers_raw as (
    ...
    join {{ ref('transfers_zksync_eth') }} as tr
    ...
    from events_raw as er
    join {{ source('erc20_zksync','evt_transfer') }} as erc20
