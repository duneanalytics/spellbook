...
SELECT
    ...
    cast(number_of_items as uint256) as nft_amount,
    cast(amount_raw as uint256) as price_raw,
    ...
    cast(taker_fee_amount_raw + maker_fee_amount_raw as uint256) as platform_fee_amount_raw,
