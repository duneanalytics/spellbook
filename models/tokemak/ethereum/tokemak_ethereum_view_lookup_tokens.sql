WITH temp_tokemak_ethereum_view_lookup_tokens(symbol, display_name, address, pricing_contract, decimals, is_pool, is_active, is_liability, is_dollar_stable) AS
(
...
SELECT 
    ...
    is_liability, 
    is_dollar_stable
FROM temp_tokemak_ethereum_view_lookup_tokens