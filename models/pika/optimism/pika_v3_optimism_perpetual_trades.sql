...
perps AS (
	SELECT
		...
		WHEN productId = UINT256 '9' OR productId = UNINT256 '23' THEN 'AAVE'
		...
		,CASE
		WHEN productId = UINT256 '1' OR productId = UINT256 '16' THEN 'ETH-USD'
		WHEN productId = UINT256 '2' OR productId = UINT256 '17' THEN 'BTC-USD'
		WHEN productId = UINT256 '3' OR productId = UINT256 '18' THEN 'LINK-USD'
		WHEN productId = UINT256 '4' OR productId = UINT256 '19' THEN 'SNX-USD'
		WHEN productId = UINT256 '5' OR productId = UINT256 '20' THEN 'SOL-USD'
		WHEN productId = UINT256 '6' OR productId = UINT256 '21' THEN 'AVAX-USD'
		WHEN productId = UINT256 '7' OR productId = UINT256 '22'  THEN 'MATIC-USD'
		WHEN productId = UINT256 '8' THEN 'LUNA-USD'
		WHEN productId = UINT256 '9' OR productId = UNINT256 '23' THEN 'AAVE-USD'
		WHEN productId = UINT256 '10' OR productId = UINT256 '24' THEN 'APE-USD'
		WHEN productId = UINT256 '11' OR productId = UINT256 '25' THEN 'AXS-USD'
		WHEN productId = UINT256 '12' OR productId = UINT256 '26' THEN 'UNI-USD'
		ELSE CONCAT ('product_id_', CAST(productId as VARCHAR))
		END AS market
