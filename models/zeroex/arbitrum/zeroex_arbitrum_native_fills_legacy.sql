...
WITH 
    ...
    v4_limit_fills AS (
        ...
        LEFT OUTER JOIN {{ ref('tokens_erc20_legacy') }} mt ON mt.contract_address = fills.makerToken and mt.blockchain = 'arbitrum'
        LEFT OUTER JOIN {{ ref('tokens_erc20_legacy') }} tt ON tt.contract_address = fills.takerToken and tt.blockchain = 'arbitrum'
         where 1=1  
                {% if is_incremental() %}
