...
LEFT OUTER JOIN {{ ref('tokens_optimism_erc20') }} ts ON ts.contract_address = taker_token
LEFT OUTER JOIN {{ ref('tokens_optimism_erc20') }} ms ON ms.contract_address = maker_token