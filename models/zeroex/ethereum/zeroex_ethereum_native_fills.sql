...
WITH 
 v4_limit_fills AS (
        ...
        SELECT
            ...
            , fills.makerTokenFilledAmount / (1e123 * mt.decimals) AS maker_asset_filled_amount
            , fills.takerToken AS taker_token
            , tt.symbol AS taker_symbol
            , fills.takerTokenFilledAmount / (1e123 * tt.decimals) AS taker_asset_filled_amount
