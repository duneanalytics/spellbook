...
LEFT OUTER JOIN {{ source('tokens_ethereum', 'erc20', True) }} ts ON ts.contract_address = taker_token
LEFT OUTER JOIN {{ source('tokens_ethereum', 'erc20', True) }} ms ON ms.contract_address = maker_token
