...
ERC20BridgeTransfer AS (
    SELECT
            ...
            block_time                              AS block_time, fills.evt_block_number as block_number,
...
direct_PLP AS (
    SELECT
            ...
            plp.evt_block_time          AS block_time, fills.evt_block_number as block_number,
            provider                    AS maker,
            recipient                   AS taker,
...
direct_uniswapv2 AS (
    SELECT
            ...
            swap.evt_block_time AS block_time, fills.evt_block_number as block_number,
