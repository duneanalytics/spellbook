...
LEFT OUTER JOIN {{ source('tokens_ethereum', 'erc20') }} ts ON ts.contract_address = taker_token and ts.blockchain = 'ethereum'
LEFT OUTER JOIN {{ source('tokens_ethereum', 'erc20') }} ms ON ms.contract_address = maker_token and ms.blockchain = 'ethereum'
