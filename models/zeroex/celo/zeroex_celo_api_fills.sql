...
SELECT 
        ...
        CASE WHEN maker_token IN ('0x471ece3750da237f93b8e339c536989b8978a438') AND  mp.price IS NOT NULL
             THEN (all_tx.maker_token_amount_raw / pow(10, mp.decimals)) * mp.price
             WHEN taker_token IN ('0x471ece3750da237f93b8e339c536989b8978a438')  AND  tp.price IS NOT NULL   
...
AND CASE
        WHEN all_tx.taker_token = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' THEN '0x471ece3750da237f93b8e339c536989b8978a438'
...
AND CASE
        WHEN all_tx.maker_token = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' THEN '0x471ece3750da237f93b8e339c536989b8978a438'
