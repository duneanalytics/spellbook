...
ERC20BridgeTransfer AS (
    SELECT 
            ...
            (bytearray_substring(DATA, 77, 20)) AS taker_token_amount_raw,
            (bytearray_substring(DATA, 110, 20)) AS maker_token_amount_raw,
...
BridgeFill AS (
    SELECT 
            ...
            (bytearray_substring(DATA, 110, 20)) AS taker_token_amount_raw,
            (bytearray_substring(DATA, 142, 20)) AS maker_token_amount_raw,
            'BridgeFill'                                    AS type,
            zeroex_tx.affiliate_address                     AS affiliate_address,
            TRUE                                            AS swap_flag,
            FALSE                                           AS matcha_limit_order_flag
