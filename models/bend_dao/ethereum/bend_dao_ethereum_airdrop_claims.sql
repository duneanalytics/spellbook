...
WITH early_price AS (
    ...
    AND contract_address='0x0d02755a5700414b26ff040e1de35d337df56218'
    )
...
, CASE WHEN t.evt_block_time >= (SELECT minute FROM early_price) THEN CAST(pu.price*t.amount/POWER(10, 18) AS double)
    ...
    END AS amount_usd
, '0x0d02755a5700414b26ff040e1de35d337df56218' AS token_address
, 'BEND' AS token_symbol
, t.evt_index
FROM {{ source('benddao_ethereum', 'MerkleDistributor_evt_Claimed') }} t
LEFT JOIN {{ ref('prices_usd_forward_fill') }} pu ON pu.blockchain = 'ethereum'
    AND pu.contract_address='0x0d02755a5700414b26ff040e1de35d337df56218'
