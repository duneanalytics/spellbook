...
{% set project_start_date = '2021-05-22' %}     -- select min(evt_block_time) from knightswap_bnb.KnightPair_evt_Swap
...
SELECT 'bnb'                                                           AS blockchain,
       ...
       knightswap_dex.token_bought_amount_raw,
       knightswap_dex.token_sold_amount_raw,
       coalesce(
