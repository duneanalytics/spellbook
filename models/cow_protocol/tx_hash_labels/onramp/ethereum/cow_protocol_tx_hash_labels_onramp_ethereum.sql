{{
	...
	tags=['legacy'],
        ...
        alias = alias('tx_hash_labels_onramp_ethereum', legacy_model=True),
    )
}}
...
with
 onramp_trades as (
    ...
    from (
        ...
        and token_bought_address not in (select contract_address from {{ ref('tokens_ethereum_erc20_stablecoins_legacy') }})
