...
FROM (VALUES
        (1, 'goerli', 'Ethereum Goerli', 'Layer 1', cast(NULL as varchar), 'ETH', 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2, 'https://goerli.etherscan.io', timestamp '2019-01-31 03:10')
