...
WITH
    ...
    bpa AS (
        ...
        FROM
            dexs
            LEFT JOIN {{ ref('balancer_v2_zkevm_bpt_prices') }} bpt_prices
...
FROM
    dexs
    INNER JOIN {{ source('zkevm', 'transactions') }} tx
    ...
    LEFT JOIN {{ source('tokens', 'erc20') }} erc20a
        ...
        AND erc20a.blockchain = 'zkevm'
    LEFT JOIN {{ source('tokens', 'erc20') }} erc20b
        ON erc20b.contract_address = dexs.token_sold_address
        AND erc20b.blockchain = 'zkevm'
    ...
    LEFT JOIN {{ ref('balancer_v2_zkevm_bpt_prices') }} bpa_bpt_prices
    ...
    LEFT JOIN {{ ref('balancer_v2_zkevm_bpt_prices') }} bpb_bpt_prices
