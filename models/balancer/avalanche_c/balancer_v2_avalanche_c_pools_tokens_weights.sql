...
SELECT
    ...
    normalizedWeights.normalized_weight / POWER(10, 18) AS normalized_weight
...
INNER JOIN {{ source('balancer_v2_avalanche_c', 'WeightedPoolFactory_call_create') }} call_create
    ...
    LATERAL VIEW posexplode(call_create.normalizedWeights) normalizedWeights AS pos, normalized_weight
