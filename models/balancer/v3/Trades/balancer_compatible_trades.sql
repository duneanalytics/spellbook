...
dexs AS (
    SELECT
        ...
        swap.swapFeeAmount AS swap_fee_amount,
        (swap.swapFeeAmount / swap.amountOut) AS swap_fee, --swapFeeAmount = Swap fee amount paid in token out
        swap.evt_tx_hash AS tx_hash,
        swap.evt_index
...
SELECT
    ...
    dexs.tx_hash,
    dexs.evt_index,
    dexs.pool_id, --keep this field? 
    dexs.swap_fee,
    dexs.swap_fee_amount --keep this field?
FROM dexs
