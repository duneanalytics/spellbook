...
WITH
    ...
    dexs AS (
        SELECT
            ...
            dexs.tx_to,
            dexs.evt_index,
            dexs_base.pool_id, --keep?
            dexs_base.swap_fee,
             dexs_base.swap_fee_amount --keep?
    ...
    bpa AS (
        ...
        FROM dexs
            LEFT JOIN {{ ref('balancer_v3_arbitrum_bpt_prices') }} bpt_prices
...
SELECT
    ...
    dexs.pool_id,
    dexs.swap_fee,
    dexs.swap_fee_amount / POWER(10, erc20a.decimals) AS swap_fee_amount,
    dexs.tx_hash,
    dexs.tx_from,
    dexs.tx_to,
    dexs.evt_index
FROM dexs
    ...
    LEFT JOIN {{ ref('balancer_v3_arbitrum_bpt_prices') }} bpa_bpt_prices
    ...
    LEFT JOIN {{ ref('balancer_v3_arbitrum_bpt_prices') }} bpb_bpt_prices
