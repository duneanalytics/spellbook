...
WITH 
    swap_fees AS (
        ...
        LEFT JOIN {{ ref('balancer_v2_gnosis_pools_fees_legacy') }} fees
    ...
    bpa AS (
        ...
        FROM
            dexs
            LEFT JOIN {{ ref('balancer_v2_gnosis_bpt_prices_legacy') }} bpt_prices
...
FROM
    ...
    LEFT JOIN {{ ref('balancer_v2_gnosis_bpt_prices_legacy') }} bpa_bpt_prices
    ...
    LEFT JOIN {{ ref('balancer_v2_gnosis_bpt_prices_legacy') }} bpb_bpt_prices
