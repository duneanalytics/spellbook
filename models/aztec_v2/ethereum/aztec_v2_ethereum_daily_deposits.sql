...
token_prices as (
 ...
 select dt.date
        ...
        , dt.num_tfers
        , dt.abs_value_norm
        , dt.abs_value_norm * p.price_usd as abs_volume_usd
        , dt.abs_value_norm * p.price_eth as abs_volume_eth
        , dt.user_deposit_value_norm * p.price_usd as user_deposits_usd
        , dt.user_deposit_value_norm * p.price_eth as user_deposits_eth
        , dt.user_withdrawal_value_norm * p.price_usd as user_withdrawals_usd
        , dt.user_withdrawal_value_norm * p.price_eth as user_withdrawals_eth
