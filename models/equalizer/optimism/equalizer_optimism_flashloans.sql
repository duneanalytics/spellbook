...
FROM {{ source('equalizer_optimism','FlashLoanProvider_evt_FlashLoan') }} flash
LEFT JOIN {{ ref('tokens_optimism_erc20_legacy') }} tok ON tok.contract_address=flash.token
