...
{% set erc1155_approvalforalls_models = [
     ...
     , ('linea', source('linea', 'evt_ApprovalForAll'))
     , ('zkevm', source('zkevm', 'evt_ApprovalForAll'))
     , ('blast', source('blast', 'evt_ApprovalForAll'))
     , ('mantle', source('mantle', 'evt_ApprovalForAll'))
] %}
