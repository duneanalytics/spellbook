...
FROM (VALUES
        ...
        , (43114, 'avalanche_c', 'Avalanche', 'Layer 1', NULL, 'AVAX', 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7, 'https://optimistic.etherscan.io', timestamp '2020-09-23 11:02')
        , (42161, 'arbitrum', 'Arbitrum', 'Layer 2', 'Optimistic Rollup', 'ETH', 0x82af49447d8a07e3bd95bd0d56f35241523fbab1, 'https://arbiscan.io', timestamp '2021-05-29 00:35')
        , (10, 'optimism', 'Optimism', 'Layer 2', 'Optimistic Rollup', 'ETH', 0x4200000000000000000000000000000000000006, 'https://optimistic.etherscan.io', timestamp '2021-11-11 21:16')
        ...
        , (137, 'polygon', 'Polygon', 'Layer 1', NULL, 'MATIC', 0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270, 'https://polygonscan.com', timestamp '2020-05-30 16:30')
        ...
        ) AS temp_table (chain_id, blockchain, name, chain_type, native_token_symbol, wrapped_native_token_address, first_block_time)
