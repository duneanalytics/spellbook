...
FROM (VALUES
        ...
        , (324, 'zksync', 'zkSync Era', 'Layer 2', 'ZK Rollup', 'ETH', NULL , 'https://explorer.zksync.io/', timestamp '2023-02-14 15:22', 'zkSync', 'ethereum')
        ...
        , (5000, 'mantle', 'Mantle', 'Layer 2', 'Optimistic Rollup', 'MNT', NULL, 'https://explorer.mantle.xyz/', timestamp '2023-07-02 18:21', NULL, 'ethereum')
        ...
        , (1313161554, 'aurora', 'Aurora', 'Layer 2', NULL, 'ETH', 0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB, 'https://explorer.aurora.dev/', NULL, NULL, NULL)
        , (8217, 'klaytn', 'Klaytn', 'Layer 1', NULL, 'KLAY', 0xe4f05a66ec68b54a58b17c22107b02e0232cc817, 'https://scope.klaytn.com/', NULL, NULL, NULL)
