...
(
	...
	INNER JOIN {{ ref('chainlink_polygon_price_feeds_oracle_addresses_legacy') }} cfa ON l.contract_address = cfa.aggregator_address
...
LEFT JOIN {{ ref('chainlink_polygon_price_feeds_oracle_token_mapping_legacy') }} o ON c.proxy_address = o.proxy_address