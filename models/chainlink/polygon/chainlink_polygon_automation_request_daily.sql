...
WITH
  automation_request_daily_meta AS (
    ...
    FROM
      ...
      FULL OUTER JOIN {{ ref('chainlink_polygon_automation_reverted_transactions') }} reverted ON
...
LEFT JOIN {{ ref('chainlink_polygon_automation_meta') }} automation_meta ON automation_meta.keeper_address = automation_request_daily.node_address
ORDER BY
  "date_start"
