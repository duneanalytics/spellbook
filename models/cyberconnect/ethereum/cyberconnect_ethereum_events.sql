...
(
  select 
            ...
            'ethereum-cyberconnect-' || 'CreateProfile'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
...
cyberconnect_essence_register as (
    select 
            ...
            'ethereum-cyberconnect-' || 'RegisterEssence'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
...
cyberconnect_essence_collect as (
    select 
            ...
            'ethereum-cyberconnect-' || 'CollectEssence'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
...
cyberconnect_subscribe as (
    select 
            ...
            NULL AS  content_id,
            NULL AS  content_uri,
            'ethereum-cyberconnect-' || 'Subscribe'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
