...
(
  select 
            ...
            'bnb-cyberconnect-' || 'CreateProfile'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
...
cyberconnect_essence_register as (
    select 
            ...
            'bnb-cyberconnect-' || 'RegisterEssence'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
...
cyberconnect_essence_collect as (
    select 
            ...
            'bnb-cyberconnect-' || 'CollectEssence'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
...
cyberconnect_subscribe as (
    select 
            ...
            NULL AS  content_id,
            NULL AS  content_uri,
            'bnb-cyberconnect-' || 'Subscribe'  || '-' || a.evt_tx_hash || '-' || a.evt_index AS unique_event_id
