...
send_detail AS (
    SELECT CAST(112 AS integer) AS source_chain_id,
...
native_transfer_value_summary AS (
    ...
    INNER JOIN {{ source('fantom', 'traces') }} e ON e.block_number = dg.block_number
...
LEFT JOIN tokens.erc20 erc ON erc.blockchain = 'fantom' AND erc.contract_address = t.currency_contract
