...
with verify_txns as (
  ...
  WHERE t.to = 0x5132a183e9f3cb7c848b0aac5ae0c4f0491b7ab2
    AND (
      bytearray_substring(t.data, 1, 4) = 0x2b0006fa -- verifyBatchesTrustedAggregator
      OR bytearray_substring(t.data, 1, 4) = 0x1489ed10 -- verifyBatchesTrustedAggregator (since block 19218496)
    )
