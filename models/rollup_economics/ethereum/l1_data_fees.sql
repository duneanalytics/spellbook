...
with tx_batch_appends as (
  ...
  INNER JOIN {{ source('prices','usd') }} p
    ...
    {% endif %}
  WHERE (
      t.to = 0xD1328C9167e0693B689b5aa5a024379d4e437858 -- Rollup Proxy (last used as of block 19437175)
      OR t.to = 0x31d543e7BE1dA6eFDc2206Ef7822879045B9f481 -- L2OutputOracle Proxy (used as of block 19440324)
      OR t.to = 0x50Fa427235C7C8cAA4A0C21b5009f5a0d015B23A -- BVM_EigenDataLayrChain Proxy (DA)
      OR t.to = 0x5BD63a7ECc13b955C4F57e3F12A64c10263C14c1 -- DataLayrServiceManager Proxy (DL)
    )
    AND (
      bytearray_substring(t.data, 1, 4) = 0x49cd3004 -- createAssertionWithStateBatch
      bytearray_substring(t.data, 1, 4) = 0x9aaab648 -- proposeL2Output
      OR bytearray_substring(t.data, 1, 4) = 0x5e4a3056 -- storeData (DA)
      OR bytearray_substring(t.data, 1, 4) = 0x4618ed87 -- confirmData (DA)
      OR bytearray_substring(t.data, 1, 4) = 0x58942e73 -- confirmDataStore (DL)
      OR bytearray_substring(t.data, 1, 4) = 0xdcf49ea7 -- initDataStore (DL)
    )
