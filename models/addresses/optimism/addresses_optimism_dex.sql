...
FROM (VALUES
      ...
      (0x96E04591579f298681361C6122Dc4Ef405c19385, 'SushiSwap', 'RouteProcessor3'),
      ...
      (0xa062ae8a9c5e11aaa026fc2670b0d65ccc8b2858, 'Velodrome', 'RouterV2'),
      ...
      (0x1337bedc9d22ecbe766df105c9623922a27963ec, 'Curve', '3pool'),
      (0xba12222222228d8ba445958a75a0704d566bf2c8, 'Beethoven X', 'Vault'),
      (0x1328ff5ac67a48c4a0a4339ff07fedf4f2a76387, 'OPX Finance', 'Router'),
      (0x7af14adc8aea70f063c7ea3b2c1ad0d7a59c4bff, 'Rubicon', 'Router'),
      (0xfd9d2827ad469b72b69329daa325ba7afbdb3c98, 'DODO', 'V2Proxy02'),
      (0x716fcc67dca500a91b4a28c9255262c398d8f971, 'DODO', 'FeeRouteProxy')
