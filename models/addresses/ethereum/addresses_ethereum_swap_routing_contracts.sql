{{config(alias='swap_routing_contracts',
...
FROM (VALUES
      ...
      ('0x84d99aa569d93a9ca187d83734c8c4a519c4e9b1', '1inch', 'Router'),
      ...
      ('0x56e9db574c8d5015d198671cbf1200b6bb2ed944', 'Convex', 'DistributorZaps'),
      ('0xf7d1fa3e46582061515aa785354e4ea19717f3d7', 'Convex', '4PoolSUSDPool'),
      ...
      ('0x99a58482bd75cbab83b27ec03ca68ff489b5788f', 'Curve', 'Vyper Contract'),
      ...
      ('0x617dee16b86534a5d792a4d7a62fb491b544111e', 'KyberSwap', 'Meta Aggreagation Router'),
      ...
      ('0x882d04c3d8410ddf2061b3cba2c3522854316feb', 'Polygon Bridge', 'Relay'),
