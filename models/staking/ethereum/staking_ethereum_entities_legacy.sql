...
WITH contracts AS (
    ...
    , ('0x9b8c989ff27e948f55b53bb19b3cc1947852e394', 'Kiln', 'Staking Pool')
...
('0xae7ab96520de3a18e5e111b5eaab095312d7fe84', 'Lido', 'Lido', 'Liquid Staking')
    ...
    , ('0x39dc6a99209b5e6b81dc8540c86ff10981ebda29', 'Staked.us', 'Staked.us', 'Staking Pool')
    ...
    , ('0x66827bcd635f2bb1779d68c46aeb16541bca6ba8', 'PieDAO', 'PieDAO', 'Staking Pool')
    ...
    --, ('0xefe9a82d56cd965d7b332c7ac1feb15c53cd4340', 'stakefish', 'stakefish 2', 'Staking Pool') -- fork of stakefish batch deposit contract that isn't controlled by stakefish
    , ('0xeee27662c2b8eba3cd936a23f039f3189633e4c8', 'Celsius', 'Celsius', 'Staking Pool')
    ...
    , ('0x3ccc0b321ec18997490c8bfc2c882ef83d546ddd', 'Cake DeFi', 'Cake DeFi', 'Staking Pool')
    ...
    , ('0xf79caa45612fb183c4e258ed449bfa632d7400b9', 'Everstake Pool', 'Everstake', 'Staking Pool')
    ...
    , ('0x4ca21e4d3a86e7399698f88686f5596dbe74adeb', 'P2P.org', 'P2P.org', 'Staking Pool')
    , ('0x8103151e2377e78c04a3d2564e20542680ed3096', 'Node DAO', 'Node DAO', 'Liquid Staking')
    , ('0x4befa2aa9c305238aa3e0b5d17eb20c045269e9d', 'RockX', 'RockX', 'Staking Pool')
