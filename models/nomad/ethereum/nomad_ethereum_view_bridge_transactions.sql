...
,nomad_bridge_transactions as (
      ...
      left join {{ ref('tokens_erc20_legacy') }} e1 on e1.contract_address = s.token and e1.blockchain = 'ethereum'
      ...
      left join {{ ref('tokens_erc20_legacy') }} e1 on e1.contract_address = r.token and e1.blockchain = 'ethereum'
