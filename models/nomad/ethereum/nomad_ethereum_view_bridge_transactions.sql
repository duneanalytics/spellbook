...
,nomad_bridge_transactions as (
      ...
      left join {{ source('tokens', 'erc20', True) }} e1 on e1.contract_address = s.token and e1.blockchain = 'ethereum'
      ...
      left join {{ source('tokens', 'erc20', True) }} e1 on e1.contract_address = r.token and e1.blockchain = 'ethereum'
