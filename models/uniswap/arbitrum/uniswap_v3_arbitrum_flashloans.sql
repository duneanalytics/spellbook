...
WITH flashloans AS (
    ...
    LEFT JOIN {{ source('tokens_arbitrum', 'erc20') }} erc20a ON p.token0 = erc20a.contract_address
    LEFT JOIN {{ source('tokens_arbitrum', 'erc20') }} erc20b ON p.token1 = erc20b.contract_address
