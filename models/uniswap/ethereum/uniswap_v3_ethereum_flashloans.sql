...
WITH flashloans AS (
    ...
    LEFT JOIN {{ ref('tokens_ethereum_erc20_legacy') }} erc20a ON p.token0 = erc20a.contract_address
    LEFT JOIN {{ ref('tokens_ethereum_erc20_legacy') }} erc20b ON p.token1 = erc20b.contract_address
