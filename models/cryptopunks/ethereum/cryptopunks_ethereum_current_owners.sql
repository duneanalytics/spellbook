...
from 
(   select wallet 
            , sum(punk_balance) as currently_holding
    from 
    (   select  to_date('2017-06-22', 'yyyy-MM-dd') as evt_block_time
                , address as wallet 
                , original_count as punk_balance 
