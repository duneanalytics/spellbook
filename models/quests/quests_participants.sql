...
UNION ALL
SELECT 'optimism' as blockchain, 'galxe' as platform, token_transfer_to as quester_address, block_number, block_time, null as quest_name, nft_contract_address as token_address, tokenId AS token_id FROM {{ ref('galxe_optimism_nft_mints') }}
