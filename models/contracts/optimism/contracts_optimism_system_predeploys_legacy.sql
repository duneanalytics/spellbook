...
-- OP Predeploys
SELECT 'OVM' as project_name, contract_name, lower(contract_address) AS contract_address
FROM (values
...
UNION ALL
-- EAS Predeploys
SELECT 'EAS' as project_name, contract_name, lower(contract_address) AS contract_address
FROM (values
	-- Other Predeploys
