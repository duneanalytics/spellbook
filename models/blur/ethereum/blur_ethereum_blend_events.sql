...
, all_events AS (
    ...
    , evt_tx_hash AS tx_hash
    , evt_index
    FROM blur_ethereum.Blend_evt_Seize seize
    ...
    , evt_tx_hash AS tx_hash
    , evt_index
    FROM blur_ethereum.Blend_evt_Repay
    ...
    , evt_tx_hash AS tx_hash
    , evt_index
    FROM blur_ethereum.Blend_evt_BuyLocked
    )
...
LEFT JOIN tokens_ethereum.nft tok ON tok.contract_address=collection
