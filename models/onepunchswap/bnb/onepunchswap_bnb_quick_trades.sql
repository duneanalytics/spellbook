...
(
    ...
    SELECT
        ...
        t.user                          AS taker,
        ''                              AS maker,
        cast(get_json_object(t.quoteInfo,'$.toAmount') as double) as token_bought_amount_raw,
        cast(get_json_object(t.quoteInfo,'$.fromAmount') as double) as token_sold_amount_raw,
        cast(NULL as double)            AS amount_usd,
        case 
            when get_json_object(t.quoteInfo,'$.toAsset') = '0x0000000000000000000000000000000000000000' then '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c'
            else get_json_object(t.quoteInfo,'$.toAsset')
        end                                                 as token_bought_address,
        case 
            when get_json_object(t.quoteInfo,'$.fromAsset') = '0x0000000000000000000000000000000000000000' then '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c'
            else get_json_object(t.quoteInfo,'$.fromAsset')
        ...
        t.evt_index
    FROM
        {{ source('onepunch_quick_bnb', 'QuickLiquidityProvider_evt_QuoteAccepted') }} t
    {% if is_incremental() %}
