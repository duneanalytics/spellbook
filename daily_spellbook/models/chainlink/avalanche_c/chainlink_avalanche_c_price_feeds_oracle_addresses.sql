...
{% set fxs_usd = 'FXS / USD' %}
{% set gmx_usd = 'GMX / USD' %}
{% set ion_digital_total_reserve = 'Ion Digital Total Reserve' %}
{% set joe_usd = 'JOE / USD' %}
{% set jpy_usd = 'JPY / USD' %}
{% set knc_usd = 'KNC / USD' %}
...
FROM (values
  ...
  ('{{ada_usd}}', 8, 0x69C2703b8F1A85a2EF6aBDd085699a9F909BE053, 0x77bf298BA2889a46c615Ea8532F7Cbd79e2E9D86),
  ('{{alpha_usd}}', 8, 0x7B0ca9A6D03FE0467A31Ca850f5bcA51e027B3aF, 0x9C81461B6B821407E0a2968F9CEc23e3C7063F84),
  ('{{arkb_reserves}}', 18, 0xfc5c89c84F7b0bd7807232ac73E737F6b3afd588, 0x30a71D863dEF98345bf6010503f95d6ec246b511),
  ...
  ('{{chf_usd}}', 8, 0xA418573AB5226711c8564Eeb449c3618ABFaf677, 0x3D22B2c729A952402d898D1041F5E4828FF3695c),
  ...
  ('{{coq_usd}}', 18, 0x5B4712ce553E94d9b22bA3CfA10CB6F32fb828E0, 0x6373b49043e5eECFAa84503432D2FC44369d4F0e),
  ...
  ('{{eurc_usd}}', 8, 0x3368310bC4AeE5D96486A73bae8E6b49FcDE62D3, 0xd089a5bcaf926263CE7C1bFC5e13f712a3257B22),
  ...
  ('{{ion_digital_total_reserve}}', 8, 0x0AB119EB3f6820BA43c345e9aAbF1e3dE3C09Ce4, 0x299e5B33B94BeC611709Ab51085C0C5aB8290Fe8),
  ...
  ('{{wsteth_steth_exchange_rate}}', 18, 0x84FF93CAD57DcD39b21895171D30A7A0e7851C75, 0xE456d8Df356a0Bdd0a3788282720fBd54674db07)
