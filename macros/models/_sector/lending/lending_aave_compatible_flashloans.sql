...
base_flashloans as (
  select
    ...
    case when _reserve = {{ aave_mock_address }} then {{ native_token_address }} else _reserve end as currency_contract,
    contract_address,
    evt_tx_hash,
    evt_index,
    evt_block_time,
...
base_flashloans as (
  select
    ...
    case when asset = {{ aave_mock_address }} then {{ native_token_address }} else asset end as currency_contract,
    contract_address,
    evt_tx_hash,
    evt_index,
    evt_block_time,
