...
*/
  ...
  FROM {{ ref('usage_summary_' + chain + '_daily_traces' + date_string) }} tr
  LEFT JOIN {{ ref('usage_summary_' + chain + '_daily_transactions' + date_string) }} tt -- all txs to have an associated trace
    ...
    {% endif %}
  FULL OUTER JOIN {{ ref('usage_summary_' + chain + '_daily_logs' + date_string) }} lo
