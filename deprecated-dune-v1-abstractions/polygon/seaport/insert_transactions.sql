...
-- but modified below
-- 1. ETH -> MATIC
-- 2. WETH -> MATIC 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2 -> 0x0000000000000000000000000000000000001010
-- 3. ethereum.transactions -> polygon.transactions
-- 4. first block_number 14801608 -> 29585000
...
,p1_txn_level as (
    select a.main_type
          ...
          ,count(distinct nft_token) as nft_address_dcnt
