CREATE OR REPLACE FUNCTION dex.insert_liquidity_sushiswap_v1(start_ts timestamptz, end_ts timestamptz=now()) RETURNS integer
...
dex_wallet_balances AS (
    ...
    WHERE project = 'Sushiswap' AND version = '1' AND liq.day >= start_ts - interval '3 days'
),
