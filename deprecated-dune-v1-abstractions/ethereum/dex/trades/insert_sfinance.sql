CREATE OR REPLACE FUNCTION dex.insert_sfinance(start_ts timestamptz, end_ts timestamptz=now(), start_block numeric=0, end_block numeric=9e18) RETURNS integer
...
WITH rows AS (
    ...
    FROM (
        ...
        SELECT
            ...
            evt_index
        FROM sfinance."5pool_router_evt_TokenExchange"
    ) dexs
