...
SUM(value) AS difference,
SUM(CASE WHEN tr_type ='Money Out' THEN value ELSE 0 END) AS money_out_raw,
SUM(CASE WHEN tr_type ='Money In' THEN value ELSE 0 END) AS money_in_raw,
SUM(CASE WHEN tr_type ='Transfer Out' THEN value ELSE 0 END) AS transfer_out,
SUM(CASE WHEN tr_type ='Transfer In' THEN value ELSE 0 END) AS transfer_in,
SUM(CASE WHEN tr_type ='Burn Out' THEN value ELSE 0 END) AS burn_out,
SUM(CASE WHEN tr_type ='Mint In' THEN value ELSE 0 END) AS mint_in,
SUM(CASE WHEN tr_type ='Rewards In' THEN value ELSE 0 END) AS rewards_in,
SUM(CASE WHEN tr_type ='Staking Out' THEN value ELSE 0 END) AS staking_out,
SUM(CASE WHEN tr_type ='Staking In' THEN value ELSE 0 END) AS staking_in,
SUM(CASE WHEN tr_type ='Swap Out' THEN value ELSE 0 END) AS swap_out,
SUM(CASE WHEN tr_type ='LEND In' THEN value ELSE 0 END) AS swap_in,

SUM(CASE WHEN tr_type IN('Money In','Mint In') THEN value ELSE 0 END) AS money_in, --protocol rev
SUM(CASE WHEN tr_type IN('Money Out','Burn Out') THEN value ELSE 0 END) AS money_out, --protocol exp
