BEGIN;
DROP VIEW IF EXISTS dune_user_generated.qidao_view_lp_staker_status CASCADE;

CREATE VIEW dune_user_generated.qidao_view_lp_staker_status as (
with dws as (
...
from user_status a inner join
     (select name as lp_name, price
      from dune_user_generated.qidao_view_lp_token_price
...
select * from dune_user_generated.qidao_view_lp_staker_status; 