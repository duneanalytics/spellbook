BEGIN;
DROP VIEW IF EXISTS dune_user_generated.qidao_view_lp_pool_withdraw CASCADE;

CREATE VIEW dune_user_generated.qidao_view_lp_pool_withdraw AS (
with withdraws as (
...
COMMIT;
select * from dune_user_generated.qidao_view_lp_pool_withdraw order by block_time desc limit 1000