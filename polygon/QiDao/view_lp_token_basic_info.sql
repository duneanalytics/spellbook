BEGIN;
DROP VIEW IF EXISTS dune_user_generated.qidao_view_lp_basic_info CASCADE;

CREATE VIEW dune_user_generated.qidao_view_lp_basic_info(lp_contract_address, dex_name, lp_name, token_a_symbol, token_b_symbol, token_a_decimals, token_b_decimals) AS VALUES
...
select * from dune_user_generated.qidao_view_lp_basic_info;