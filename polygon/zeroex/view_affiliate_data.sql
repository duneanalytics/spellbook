...
WITH rows AS (
    ...
    WHERE
        tr."to" ='\xdef1c0ded9bec7f1a1670819833240f027b25eff'::BYTEA
    AND (
...
SELECT zeroex.insert_api_data('2021-03-01', now()) WHERE NOT EXISTS (SELECT * FROM zeroex.view_api_affiliate_data);
