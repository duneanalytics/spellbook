...
{% set remove_margin_v1_call_tables = [
    ...
    ,'TradingV7_call_removeMargin'
    ,'TradingV8_call_removeMargin'
] %}

{% set add_margin_v1_call_tables = [
    'TradingV5_call_addMargin'
    ,'TradingV6_call_addMargin'
    ,'TradingV7_call_addMargin'
    ,'TradingV8_call_addMargin'
] %}
...
modify_margin_v1 as (  
        ...
        WHERE mm.evt_tx_hash NOT IN (0x561cde89720f8af596bf8958dd96339d8b3923094d6d27dd8bf14f5326c9ae25, 0x17e49a19c4feaf014bf485ee2277bfa09375bde9931da9a95222de7a1e704d70, 0x146e22e33c8218ac8c70502b292bbc6d9334983135a1e70ffe0125784bfdcc91)
),
