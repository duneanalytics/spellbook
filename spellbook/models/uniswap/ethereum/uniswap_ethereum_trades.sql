...
SELECT blockchain, project, version, block_time, amount_usd, token_a_symbol, token_b_symbol, 
       token_a_amount, token_b_amount, trader_a, trader_b, amount_usd, token_a_address, 
