...
('BCP'::text,   'pieDAO'    ::text, '\xe4f726adc8e89c6a6017f01eada77865db22da14'::bytea,    '\xd485e6a0389A42D75f4b00EcE91fc02340B73938'::bytea, 'wip'::text),
('DEFI++'::text,'pieDAO'    ::text, '\x8d1ce361eb68e9e05573443c407d4a3bed23b033'::bytea,    '\x25af1F2c3772d6F19Aa6615571203757365D29C6'::bytea, 'wip'::text),
