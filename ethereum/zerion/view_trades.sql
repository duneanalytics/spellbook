...
BEGIN
  ...
  INSERT INTO dune_user_generated.zerion_trades_reworked
  SELECT *
  FROM (
...
--backfill
SELECT zerion.view_trades('2019-01-01', (SELECT NOW() - interval '20 minutes')) WHERE NOT EXISTS (SELECT * FROM zerion.view_trades LIMIT 1);
