...
WITH calendar AS  
        ...
        WHERE NOT (i>'2022-05-08' AND (tl.address='\xa47c8bf37f92aBed4A126BDA807A7b7498661acD' OR tl.address='\xa693b19d2931d498c5b318df961919bb4aee87a5' OR tl.address = '\xCEAF7747579696A2F0bb206a14210e3c9e6fB269'))--remove UST tokens and pools
 ) ,
 result AS (
...
VALUES ('* 2 * * *', $$REFRESH MATERIALIZED VIEW CONCURRENTLY tokemak.view_tokemak_wallet_balances_daily$$)
