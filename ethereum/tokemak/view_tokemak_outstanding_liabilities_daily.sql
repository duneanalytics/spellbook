...
WITH calendar AS  
        ...
        WHERE tl.is_liability = true AND NOT (i>'2022-05-08' AND (tl.address='\x7A75ec20249570c935Ec93403A2B840fBdAC63fd' OR tl.address='\x482258099de8de2d0bda84215864800ea7e6b03d')) order by "date" desc
 ) ,
minted as (
    SELECT 
