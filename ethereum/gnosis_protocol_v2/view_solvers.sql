...
known_solver_metadata (address, environment, name) as (
    ...
    FROM (VALUES ('0xf2d21ad3c88170d4ae52bbbeba80cb6078d276f4', 'prod', 'MIP'),
                 ('0x15f4c337122ec23859ec73bec00ab38445e45304', 'prod', 'ParaSwap'),
                 ('0xde1c59bc25d806ad9ddcbe246c4b5e5505645718', 'prod', '1inch'),
                 ('0x340185114f9d2617dc4c16088d0375d09fee9186', 'prod', 'Naive'),
                 ('0x833f076d182123ca8dde2743045ea02957bd61ef', 'prod', 'Baseline'),
                 ('0xe92f359e6f05564849afa933ce8f62b8007a1d5d', 'prod', '0x'),
                 ...
                 ('0xa97DEF4fBCBa3b646dd169Bc2eeE40f0f3fE7771', 'prod', 'BalancerSOR'),
                 ...
                 ('0xb20B86C4e6DEEB432A22D773a221898bBBD03036', 'prod', '1inch'),
                 ('0xE9aE2D792F981C53EA7f6493A17Abf5B2a45a86b', 'prod', 'ParaSwap'),
                 ('0xdA869Be4AdEA17AD39E1DFeCe1bC92c02491504f', 'prod', '0x'),
                 ('0x6D1247b8ACf4dFD5Ff8cfD6C47077ddC43d4500E', 'prod', 'DexCowAgg'),
                 ('0xF7995B6B051166eA52218c37b8d03A2A6bbeF3DA', 'prod', 'BalancerSOR'),
                 ...
                 ('0x97dd6a023b06ba4722aF8Af775ec3C2361e66684', 'barn', '0x'),
                 ('0x6372bcbf66656e91b9213b61d861b5e815296207', 'barn', 'ParaSwap'),
                 ('0x158261d17d2983b2cbaecc1ae71a34617ae4cb16', 'barn', 'MIP'),
                 ('0x8c9d33828dace1eb9fc533ffde88c4a9db115061', 'barn', '1inch'),
                 ...
                 ('0xe33062a24149f7801a48b2675ed5111d3278f0f5', 'barn', '1inch'),
                 ('0x080a8b1e2f3695e179453c5e617b72a381be44b9', 'barn', 'ParaSwap'),
                 ('0xde786877a10dbb7eba25a4da65aecf47654f08ab', 'barn', '0x'),
                 ('0xdae69affe582d36f330ee1145995a53fab670962', 'barn', 'DexCowAgg'),
                 ('0x0b78e29ee55aa73b366730cf512d65c514eeb196', 'barn', 'BalancerSOR'),
                 ('0x22dee0935c77d32c7241362b14e76fc2d5ef657d', 'barn', 'BalancerSOR'),
