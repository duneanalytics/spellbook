...
, tt.to AS address
, MIN_BY(tt."from", (tt.block_number, tt.tx_index, tt.evt_index)) AS first_funded_by
, MIN_BY(tt.tx_from, (tt.block_number, tt.tx_index)) AS first_funding_executed_by
, MIN_BY(tt.amount, (tt.block_number, tt.tx_index, tt.evt_index)) AS amount
, MIN_BY(tt.amount_usd, (tt.block_number, tt.tx_index, tt.evt_index)) AS amount_usd
...
, MIN_BY(tt.unique_key, (tt.block_number, tt.tx_index, tt.evt_index)) AS unique_key
