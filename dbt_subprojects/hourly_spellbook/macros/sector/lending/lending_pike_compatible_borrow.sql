{% macro lending_pike_compatible_borrow(blockchain, project, version, borrow_table, deploy_market_table) %}
...
WITH borrow_events AS (
    ...
    JOIN {{source(project ~ '_' ~ blockchain, deploy_market_table)}} dm 
