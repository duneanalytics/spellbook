...
WITH events AS (
    SELECT CASE lower(d.destinationChain)
...
, e.block_time
, e.block_number
, e.deposit_amount_raw
, e.sender
, e.recipient
, e.deposit_token_address
, 'erc20' AS deposit_token_standard
, e.tx_from
, e.tx_hash
, e.evt_index
, e.contract_address
, {{ dbt_utils.generate_surrogate_key(['e.tx_hash', 'e.evt_index']) }} as bridge_transfer_id
FROM events e
LEFT JOIN {{ source('evms','info') }} i ON e.withdrawal_chain=i.blockchain
