...
{% test check_seaport_seed(model, blockchain=None, project=None, version=None) %}
    ...
    {{ check_seed_macro(model,ref('seaport_trades_seed'),seed_matching_columns,seed_check_columns,filter) }}
