...
{{
    erc4337_userops_basics(
        blockchain = 'polygon',
        version = 'v0.7',
        userops_evt_model = source('erc4337_polygon','entrypoint_v0_7_evt_useroperationevent'),
        handleops_call_model = source('erc4337_polygon', 'entrypoint_v0_7_call_handleops')
    )
}}