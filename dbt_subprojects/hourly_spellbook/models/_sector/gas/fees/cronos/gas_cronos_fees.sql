...
-- cronos is an EIP-1559 L1 (native token CRO). Unlike morph it has no l1_fee,
-- so this mirrors the standard L1 pattern (fantom / gnosis): tx_fee_raw is
-- gas_price * gas_used with a base_fee / priority_fee breakdown.
