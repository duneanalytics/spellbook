...
SELECT
    ...
    ,cast(null as map<varchar,uint256) as tx_fee_breakdown_raw
    ,cast(null as map<varchar,double) as tx_fee_breakdown
    ,cast(null as map<varchar,double) as tx_fee_breakdown_usd
    ,tx_fee_currency
