...
(
    ...
    post_hook='{{ expose_spells(\'["arbitrum", "avalanche_c", "bnb", "ethereum", "fantom", "gnosis", "optimism", "polygon", "celo", "zora", "base", "scroll", "zksync", "sei", "mantle", "blast", "ronin", "nova", "abstract", "berachain", "katana", "ink", "opbnb", "unichain"]\',
                                    "sector",
                                    "addresses_events",
                                    \'["hildobby"]\') }}'
)
...
, (ref('addresses_events_ink_first_token_received'))
, (ref('addresses_events_opbnb_first_token_received'))
, (ref('addresses_events_unichain_first_token_received'))
] %}
