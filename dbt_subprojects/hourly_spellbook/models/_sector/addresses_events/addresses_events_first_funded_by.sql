...
(
    ...
    post_hook='{{ expose_spells(\'["arbitrum", "avalanche_c", "bnb", "ethereum", "fantom", "gnosis", "optimism", "polygon", "celo", "zora", "base", "scroll", "mode", "sei", "mantle", "bob", "degen"]\',
                                    "sector",
                                    "addresses_events",
                                    \'["hildobby"]\') }}'
)
...
, ref('addresses_events_mode_first_funded_by')
, ref('addresses_events_sei_first_funded_by')
, ref('addresses_events_mantle_first_funded_by')
, ref('addresses_events_bob_first_funded_by')
, ref('addresses_events_degen_first_funded_by')
] %}
