...
(
    ...
    post_hook='{{ expose_spells(\'["arbitrum", "avalanche_c", "bnb", "ethereum", "fantom", "gnosis", "optimism", "polygon", "celo", "zora", "base", "scroll", "zksync", "sei", "mantle", "blast", "ronin", "nova", "shape"]\',
                                    "sector",
                                    "addresses_events",
...
, (ref('addresses_events_shape_first_funded_by'), 'ETH')
] %}
