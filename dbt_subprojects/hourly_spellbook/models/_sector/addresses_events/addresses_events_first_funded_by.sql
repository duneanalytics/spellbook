...
(
    ...
    post_hook='{{ expose_spells(\'["arbitrum", "avalanche_c", "bnb", "ethereum", "fantom", "gnosis", "optimism", "polygon", "celo", "zora", "base", "scroll", "zksync", "sei", "mantle", "blast", "berachain"]\',
                                    "sector",
                                    "addresses_events",
                                    \'["hildobby"]\') }}'
)
...
, (ref('addresses_events_blast_first_funded_by'), 'BLAST')
, (ref('addresses_events_bera_first_funded_by'), 'BERA')
] %}
