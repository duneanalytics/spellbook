...
with tx_batch_appends as (
  ...
  WHERE (
      ...
      OR t.to = 0x50Fa427235C7C8cAA4A0C21b5009f5a0d015B23A -- BVM_EigenDataLayrChain Proxy (DA1) (last used as of block 19437271)
      OR t.to = 0x5BD63a7ECc13b955C4F57e3F12A64c10263C14c1 -- DataLayrServiceManager Proxy (DA2) (used as of block 19439557)
    )
    AND (
      bytearray_substring(t.data, 1, 4) = 0x49cd3004 -- createAssertionWithStateBatch
      OR bytearray_substring(t.data, 1, 4) = 0x9aaab648 -- proposeL2Output
      OR bytearray_substring(t.data, 1, 4) = 0x5e4a3056 -- storeData (DA1)
      OR bytearray_substring(t.data, 1, 4) = 0x4618ed87 -- confirmData (DA1)
