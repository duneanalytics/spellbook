{{ config(
        ...
        post_hook='{{ expose_spells(\'["arbitrum","avalanche_c","base","blast","bnb","celo","ethereum","gnosis","goerli","linea","mantle","optimism","polygon","scroll","worldchain","zkevm","zksync"]\',
                                "project",
                                "safe",
...
,ref('safe_worldchain_eth_transfers')
