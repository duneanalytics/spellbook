...
,ref('safe_berachain_transactions')
...
,ref('safe_hyperevm_transactions')
,ref('safe_ink_transactions')
,ref('safe_linea_transactions')
,ref('safe_mantle_transactions')
,ref('safe_megaeth_transactions')
,ref('safe_monad_transactions')
,ref('safe_optimism_transactions')
,ref('safe_polygon_transactions')
,ref('safe_robinhood_transactions')
,ref('safe_scroll_transactions')
,ref('safe_sonic_transactions')
,ref('safe_tempo_transactions')
