...
select
    ...
    case
        ...
        when et.to = 0x69f4D1788e39c87893C980c06EdF4b7f686e2938 then '1.3.0-EIP155'
    ...
    et.tx_hash
from {{ source('sonic', 'traces') }} et
join {{ ref('safe_sonic_singletons') }} s
    on et.to = s.address
