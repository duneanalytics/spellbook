{{ config(
        ...
        post_hook='{{ expose_spells(blockchains = \'["arbitrum", "avalanche_c", "base", "ethereum", "gnosis", "optimism", "polygon","plasma", "zkevm", "hyperevm"]\',
                                spell_type = "project",
                                spell_name = "balancer",
...
FROM {{ source("balancer", "dataset_factory_pool_mapping", database = "dune") }} m
