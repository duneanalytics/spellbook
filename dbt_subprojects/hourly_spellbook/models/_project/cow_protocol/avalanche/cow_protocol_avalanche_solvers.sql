...
solver_activation_events as (
    ...
    from {{ source('gnosis_protocol_v2_avalanche', 'GPv2AllowListAuthentication_evt_SolverAdded') }}
    union
    select solver, evt_block_number, evt_index, False as activated
    from {{ source('gnosis_protocol_v2_avalanche', 'GPv2AllowListAuthentication_evt_SolverRemoved') }}
),
...
known_solver_metadata (address, environment, name) as (
    ...
    from (
      VALUES
                ...
                (0x38Bab8A30829Ea64728Be88a75acFe5f67dDFc8B, 'barn', 'Gnosis_1inch'),
                ...
                (0x0387f1b5Ca46Aec3542A6F399Ecb3A04953ec66A, 'prod', 'Gnosis_1inch'),
