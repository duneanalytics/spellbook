...
known_solver_metadata (address, environment, name) as (
    ...
    from (
        VALUES   (0xf2d21ad3c88170d4ae52bbbeba80cb6078d276f4, 'prod', 'MIP'),
                 ...
                 (0x8A75ee64b4A40f679aD98Bcc38312702971e07B7, 'prod', 'OneBit Quant'),
                 (0x2224eAaCC7c2DBf85d5355BAb9E9271e01d30b55, 'prod', 'Sector Finance'),
                 ...
                 (0xe2823b5bD541ba8BFF3D4BF55396567440772Eab, 'barn', 'OneBit Quant'),
                 (0x71cac0127254DEfFf2c7386E6286AeaF947F033B, 'barn', 'Sector Finance'),
