...
known_solver_metadata (address, environment, name) as (
    ...
    from (
      VALUES
                ...
                (0x9775be2Bb0B72d4eA98Bfd38024EF733dc048a30, 'barn', 'Kipseli'),
                ...
                (0x41f387db8470c99b7f376212075e2E289f085Ce9, 'prod', 'Kipseli'),
                ...
                (0xa1789d24ede2d75b737cc180df762e31dfaf64ed, 'barn', 'Bitget Wallet')
    ) as _
)
