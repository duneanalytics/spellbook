...
eth_flow_orders as (
    select
        ...
        case
            when event.contract_address = 0x5A5b8aE7a0b4C0EAf453d10DCcfbA413f07ebdC2 then 'prod'
            when event.contract_address = 0xFb337f8a725A142f65fb9ff4902d41cc901de222 then 'barn'
        end as environment,
        date_format(
