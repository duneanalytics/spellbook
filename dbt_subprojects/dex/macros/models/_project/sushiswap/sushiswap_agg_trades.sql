{% macro generate_sushiswap_trades(chain) %}
  {% set fn_map = {
    ...
    'routeprocessor8_call_processRoute'                        : '8',
    'routeprocessor8_call_transferValueAndprocessRoute'        : '8',
    'routeprocessor8_call_processRouteWithTransferValueOutput' : '8',
    'routeprocessor8_call_processRouteWithTransferValueInput'  : '8',
    'routeprocessor9_call_processRoute'                        : '9',
    ...
    'routeprocessor9_2_call_processRoute'                        : '9.2',
    'routeprocessor9_2_call_transferValueAndprocessRoute'        : '9.2',
    'routeprocessor9_2_call_processRouteWithTransferValueOutput' : '9.2',
    'routeprocessor9_2_call_processRouteWithTransferValueInput'  : '9.2',
    'routeprocessor10_call_processRoute'                         : '10',
    'routeprocessor10_call_transferValueAndprocessRoute'         : '10',
    'routeprocessor10_call_processRouteWithTransferValueOutput'  : '10',
    'routeprocessor10_call_processRouteWithTransferValueInput'   : '10',
    'routeprocessor11_call_processRoute'                         : '11',
    'routeprocessor11_call_transferValueAndprocessRoute'         : '11',
    'routeprocessor11_call_processRouteWithTransferValueOutput'  : '11',
    'routeprocessor11_call_processRouteWithTransferValueInput'   : '11',
    'routeprocessor12_call_processRoute'                         : '12',
    'routeprocessor12_call_transferValueAndprocessRoute'         : '12',
    'routeprocessor12_call_processRouteWithTransferValueOutput'  : '12',
    'routeprocessor12_call_processRouteWithTransferValueInput'   : '12',
  } %}

{% set versions_by_chain = {
  'apechain'    : ['6','6.1','7','9','9.1','9.2','10','11','12'],
  'arbitrum'    : ['1','2','3.1','4','5','6','6.1','7','8','9','9.1','9.2','10','11','12'],
  'avalanche_c' : ['1','2','4','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'base'        : ['3','3.1','3.2','4','5','6','6.1','7','8','9','9.1','9.2','10','11','12'],
  'berachain'   : ['9.1','9.2','10','11','12'],
  'blast'       : ['4','5','6','6.1','7','9','9.1'],
  'bnb'         : ['1','2','3','3.2','4','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'boba'        : ['11','12'],
  'celo'        : ['4','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'ethereum'    : ['3.2','4','5','6','6.1','7','8','9','9.1','9.2','10','11','12'],
  'fantom'      : ['1','2','3.2','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'gnosis'      : ['1','2','3','3.2','4','5','6','6.1','7','9','9.1','9.2','10','11'],
  'hemi'        : ['5','6.1','7','9','9.1','9.2','10','11','12'],
  'hyperevm'    : ['9.1','9.2','10','11','12'],
  'katana'      : ['7','8','9','9.1','9.2','10','11','12'],
  'linea'       : ['3','4','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'mantle'      : ['5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'megaeth'     : ['11','12'],
  'monad'       : ['9.2','10','11','12'],
  'nova'        : ['1','2','3','3.2','4','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'optimism'    : ['3.2','4','5','6','6.1','7','8','9','9.1','9.2','10','11','12'],
  'plasma'      : ['11','12'],
  'polygon'     : ['1','2','3','3.1','3.2','4','5','6','6.1','7','8','9','9.1','9.2','10','11','12'],
  'scroll'      : ['3.2','4','5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'sonic'       : ['5','6','6.1','7','9','9.1','9.2','10','11','12'],
  'taiko'       : ['9.2','10','12'],
  'xlayer'      : ['11','12'],
  'zksync'      : ['5','6','6.1','7','9','9.1','9.2','10','11','12']
} %}
