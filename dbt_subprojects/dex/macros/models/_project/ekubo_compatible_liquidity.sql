...
liquidity_events as (
    select 
        ...
        poolId as id,
        CASE WHEN '{{version}}' = '3' THEN varbinary_to_decimal(substr(balanceUpdate, 1, 16)) ELSE delta0 END as amount0,
        CASE WHEN '{{version}}' = '3' THEN varbinary_to_decimal(substr(balanceUpdate, 1+16, 16)) ELSE delta1 END as amount1,
