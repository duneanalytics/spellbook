        ...
        set contracts = {
            "LimitOrderProtocolV1": {
                ...
                "methods": {
                    "fillOrder":    dict(samples["v2"],
                        selector    ="0xf3432b1a",
                        maker       ="substr(from_hex(json_value(data, 'lax $.makerAssetData')), 4 + 12 + 1, 20)",
                        maker_amount="bytearray_to_uint256(substr(from_hex(json_value(data, 'lax $.makerAssetData')), 4 + 32*2 + 1, 32))",
                        taker_amount="bytearray_to_uint256(substr(from_hex(json_value(data, 'lax $.takerAssetData')), 4 + 32*2 + 1, 32))",
                    ),
            ...
            "LimitOrderProtocolV2": {
                ...
                "methods": {
                    ...
                    "fillOrderTo":              dict(samples["v2"], selector="0xb2610fe3", receiver="from_hex(json_value(data, 'lax $.receiver'))"),
                    "fillOrderToWithPermit":    dict(samples["v2"], selector="0x6073cc20", receiver="from_hex(json_value(data, 'lax $.receiver'))"),
            ...
            "AggregationRouterV5": {
                ...
                "methods": {
                    ...
                    "fillOrderTo":              dict(samples["v2"],
                        ...
                        receiver        ="from_hex(json_value(data, 'lax $.receiver'))",
                    ),
                    "fillOrderToWithPermit":    dict(samples["v2"], selector="0xd365c695", order_hash="output_2", receiver="from_hex(json_value(data, 'lax $.receiver'))"),
