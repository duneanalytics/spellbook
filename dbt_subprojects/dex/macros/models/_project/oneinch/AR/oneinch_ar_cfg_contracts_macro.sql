...
{%
    set contracts = {
        ...
        "AggregationRouterV5": {
            ...
            "addresses": {
                "0x11111112542d85b3ef69ae05771c2dccff4faa26": ['ethereum','bnb','polygon','arbitrum','optimism','avalanche_c','gnosis','fantom','base'],
            ...
            "methods": {
                ...
                "clipperSwapTo":             dict(samples["clipper"], selector='0x93d4fa5', dst_receiver="recipient"),
                "clipperSwapToWithPermit":   dict(samples["clipper"], selector='0xc805a666', dst_receiver="recipient"),
                "unoswap":                   dict(samples["unoswap v3-v5"], selector='0x502b1c5', src_token_address="srcToken"),
        ...
        "AggregationRouterV6": {
            ...
            "addresses": {
                "0x11111112542d85b3ef69ae05771c2dccff4faa26": ['ethereum','bnb','polygon','arbitrum','optimism','avalanche_c','gnosis','fantom','base','linea','sonic','unichain'],
                "0x6e2b76966cbd9cf4cc2fa0d76d24d5241e0abc2f": ['zksync'],
            },
            "start": "2024-02-12",
            "methods": {
                "swap":          dict(samples["swap"], selector='0x7ed2379', src_token_amount="output_spentAmount"),
                ...
                "ethUnoswapTo2": dict(samples["unoswap v6"], selector='0xf449d71', src_token_address=native, src_token_amount="call_value", dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex,dex2]"),
