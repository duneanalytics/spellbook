{% macro oneinch_ar_contracts_cfg_macro() %}
...
{%
    set samples = {
        ...
        "swap": {
            "src_token_address"     : "from_hex(json_value(desc, 'lax $.srcToken'))",
...
{%
    set contracts = {
        ...
        "AggregationRouterV6": {
            ...
            "start": "2024-02-12",
            "methods": {
                "swap"          : dict(samples["swap"], selector='0x07ed2379', src_token_amount="output_spentAmount", useful="4 + 32*10 + length(data)"),
                "clipperSwap"   : dict(samples["clipper"], selector='0xd2d374e5', src_token_address="substr(cast(srcToken as varbinary), 13)", useful="4 + 32*8", blockchains=["ethereum","bnb","polygon","arbitrum","optimism","avalanche_c","gnosis","fantom","base"]),
                "clipperSwapTo" : dict(samples["clipper"], selector='0xc4d652af', src_token_address="substr(cast(srcToken as varbinary), 13)", useful="4 + 32*9", blockchains=["ethereum","bnb","polygon","arbitrum","optimism","avalanche_c","gnosis","fantom","base"], dst_receiver="recipient"),
                "ethUnoswap"    : dict(samples["unoswap v6"], selector='0xa76dfc3b', src_token_address=native, src_token_amount="call_value", pools="array[dex]", useful="4 + 32*2"),
                "ethUnoswap2"   : dict(samples["unoswap v6"], selector='0x89af926a', src_token_address=native, src_token_amount="call_value", pools="array[dex,dex2]", useful="4 + 32*3"),
                "ethUnoswap3"   : dict(samples["unoswap v6"], selector='0x188ac35d', src_token_address=native, src_token_amount="call_value", pools="array[dex,dex2,dex3]", useful="4 + 32*4"),
                "ethUnoswapTo"  : dict(samples["unoswap v6"], selector='0x175accdc', src_token_address=native, src_token_amount="call_value", dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex]", useful="4 + 32*3"),
                "ethUnoswapTo2" : dict(samples["unoswap v6"], selector='0x0f449d71', src_token_address=native, src_token_amount="call_value", dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex,dex2]", useful="4 + 32*4"),
                "ethUnoswapTo3" : dict(samples["unoswap v6"], selector='0x493189f0', src_token_address=native, src_token_amount="call_value", dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex,dex2,dex3]", useful="4 + 32*5"),
                "unoswap"       : dict(samples["unoswap v6"], selector='0x83800a8e', pools="array[dex]", useful="4 + 32*4"),
                "unoswap2"      : dict(samples["unoswap v6"], selector='0x8770ba91', pools="array[dex,dex2]", useful="4 + 32*5"),
                "unoswap3"      : dict(samples["unoswap v6"], selector='0x19367472', pools="array[dex,dex2,dex3]", useful="4 + 32*6"),
                "unoswapTo"     : dict(samples["unoswap v6"], selector='0xe2c95c82', dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex]", useful="4 + 32*5"),
                "unoswapTo2"    : dict(samples["unoswap v6"], selector='0xea76dddf', dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex,dex2]", useful="4 + 32*6"),
                "unoswapTo3"    : dict(samples["unoswap v6"], selector='0xf7a70056', dst_receiver='substr(cast("to" as varbinary), 13)', pools="array[dex,dex2,dex3]", useful="4 + 32*7"),
...
{% macro oneinch_ethereum_ar_contracts_cfg_macro() %}
    ...
    {{ return(dict(contracts, AggregationRouterV4=dict(contracts.AggregationRouterV4, methods={
...
{% macro oneinch_zksync_ar_contracts_cfg_macro() %}
    ...
    {{ return({
        ...
        "AggregationRouterV6": dict(contracts.AggregationRouterV6, address="0x6fd4383cb451173d5f9304f041c7bcbf27d561ff", methods={
