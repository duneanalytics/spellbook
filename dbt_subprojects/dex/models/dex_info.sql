...
FROM (VALUES
    ...
    , ('cetus', 'Cetus', 'Direct', 'CetusProtocol')
    , ('aftermath', 'Aftermath', 'Direct', 'AftermathFi')
    , ('momentum', 'Momentum', 'Direct', 'MMTFinance')
    , ('bluefin', 'Bluefin', 'Direct', 'bluefinapp')
    , ('kriya', 'Kriya', 'Direct', 'KriyaDEX')
    , ('bluemove', 'Bluemove', 'Direct', 'BlueMove_OA')
    , ('flowx', 'FlowX', 'Direct', 'FlowX_finance')
    , ('obric', 'Obric', 'Direct', 'poor_obric')
