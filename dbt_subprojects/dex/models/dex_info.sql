...
FROM (VALUES
    ...
    , ('up', 'UP', 'Direct', 'uponrh')
    , ('frothswap', 'FrothSwap', 'Direct', 'froth_meme')
    , ('thor', 'Thor V3', 'Direct', '')
    , ('factory_b4ec911f', 'Unregistered factory 0xb4eC911f', 'Direct', '')
    , ('factory_c4c1d1d9', 'Unregistered factory 0xc4c1d1d9', 'Direct', '')
    , ('factory_46c695d1', 'Unregistered factory 0x46c695d1', 'Direct', '')
    , ('apex_cl', 'Apex CL', 'Direct', '')
