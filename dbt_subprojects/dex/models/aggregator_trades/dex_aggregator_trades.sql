{{ config(
        ...
        post_hook='{{ expose_spells(\'["ethereum", "gnosis", "avalanche_c", "fantom", "bnb", "optimism", "arbitrum", "arc", "base", "linea", "scroll", "polygon", "celo", "blast", "ink", "monad", "tempo", "unichain", "worldchain", "zora"]\',
                                "sector",
                                "dex_aggregator",
