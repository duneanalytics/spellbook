...
{%
    set config_sources = [
        {
            'version': 'elastic',
            'source_evt_swap': 'Elastic_Pool_evt_swap',
            'source_evt_factory': 'Elastic_Factory_evt_PoolCreated'
        },
        {
            'version': 'elastic_2',
...
dexs_classic AS (
    {{
        uniswap_compatible_v2_trades(
            ...
            project = 'kyberswap',
            version = 'classic',
            Pair_evt_Swap = source('kyber_optimism', 'DMM_Pool_evt_Swap'),
            Factory_evt_PairCreated = source('kyberswap_optimism', 'DMM_Factory_evt_PoolCreated'),
