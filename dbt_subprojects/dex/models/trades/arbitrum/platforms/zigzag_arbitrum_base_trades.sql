...
with dexs as (
    select
      ...
      104000000 + row_number() OVER(PARTITION BY call_tx_hash ORDER BY zzmo.makerOrder) AS evt_index, -- synthetic: trace-derived, offset clear of real log indices (bands in dex/README.md)
