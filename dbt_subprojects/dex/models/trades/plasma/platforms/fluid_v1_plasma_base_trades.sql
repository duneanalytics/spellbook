...
{% set native_address = '0x12feff486d10c87f346aaa5855e036185292cd0b' %}
...
WITH 
  decoded_events AS (
      SELECT
          ...
          , t.evt_index
      FROM {{ source('fluid_plasma', 'FluidDexT1_evt_Swap') }} t
      INNER JOIN {{ source('fluid_plasma', 'fluiddexfactory_call_deploydex') }} p
