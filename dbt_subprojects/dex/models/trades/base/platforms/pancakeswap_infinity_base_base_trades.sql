{{ 
    config(
    schema = 'pancakeswap_infinity_base'
    , alias = 'base_trades'
...
dexs_clamm AS (
    ...
    {{
        pancakeswap_compatible_infinity_cl_trades(
            ...
            , project = 'pancakeswap'
            , version = 'infinity_cl'
            , PoolManager_call_Swap = source('pancakeswap_infinity_base', 'ClPoolManager_call_Swap') 
...
dexs_lbamm AS (
    ...
    {{
        pancakeswap_compatible_infinity_lb_trades(
            ...
            , project = 'pancakeswap'
            , version = 'infinity_lb'
            , PoolManager_call_Swap = source('pancakeswap_infinity_base', 'BinPoolManager_call_Swap') 
            , PoolManager_evt_Swap = source('pancakeswap_infinity_base', 'BinPoolManager_evt_Swap') 
        )
    }}
)
