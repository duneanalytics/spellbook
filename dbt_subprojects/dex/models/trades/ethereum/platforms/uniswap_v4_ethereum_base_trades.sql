...
-- and are reclassified into dex_aggregator.trades (see uniswap_v4_ethereum_aggregator_base_trades);
-- the heavy swap parsing lives in uniswap_v4_ethereum_swaps
select
        blockchain
        , project
        , version
