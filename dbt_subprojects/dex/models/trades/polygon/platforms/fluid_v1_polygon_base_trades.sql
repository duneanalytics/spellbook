...
{% set native_address = '0x0000000000000000000000000000000000001010' %}
...
WITH 
  decoded_events AS (
      SELECT
          ...
          , t.evt_index
      FROM {{ source('fluid_polygon', 'FluidDexT1_evt_Swap') }} t
      INNER JOIN {{ source('fluid_polygon', 'fluiddexfactory_call_deploydex') }} p
