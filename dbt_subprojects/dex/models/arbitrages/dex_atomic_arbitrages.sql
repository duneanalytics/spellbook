{{ config(
        ...
        post_hook='{{ expose_spells(\'["ethereum", "bnb", "avalanche_c", "gnosis", "optimism", "arbitrum", "fantom", "polygon", "base", "celo", "zksync", "scroll", "zora", "sei", "mantle", "mode", "unichain"]\',
                                "sector",
                                "dex",
                                \'["hildobby"]\') }}'
        )
...
{% set arbitrages_models = [
     ...
     , (ref('dex_scroll_atomic_arbitrages'))
     , (ref('dex_zora_atomic_arbitrages'))
     , (ref('dex_unichain_atomic_arbitrages'))
     , (ref('dex_sei_atomic_arbitrages'))
     , (ref('dex_mantle_atomic_arbitrages'))
     , (ref('dex_mode_atomic_arbitrages'))
] %}
