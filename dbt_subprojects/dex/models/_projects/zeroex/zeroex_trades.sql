{{ config(
    schema = 'zeroex'
        ,alias = 'trades'
        ,post_hook='{{ expose_spells(\'["ethereum","arbitrum", "optimism", "polygon","fantom","avalanche_c","bnb","base","scroll","linea","blast","mantle","mode", "worldchain", "unichain","berachain","ink", "monad"]\',
                                "project",
                                "zeroex",
                                \'["rantum","bakabhai993"]\') }}'
        )
