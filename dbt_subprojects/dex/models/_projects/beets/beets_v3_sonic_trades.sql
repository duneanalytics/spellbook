...
WITH
    ...
    bpa AS (
        ...
        FROM dexs
            LEFT JOIN {{ source('beethoven_x', 'bpt_prices') }} bpt_prices
...
FROM dexs
    ...
    LEFT JOIN {{ source('beethoven_x', 'bpt_prices') }} bpa_bpt_prices
    ...
    LEFT JOIN {{ source('beethoven_x', 'bpt_prices') }} bpb_bpt_prices
