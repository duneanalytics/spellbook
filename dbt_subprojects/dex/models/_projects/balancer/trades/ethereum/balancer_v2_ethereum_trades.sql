...
WITH
    ...
    dexs AS (
        SELECT
            ...
            dexs_base.pool_type
        FROM {{ ref('dex_ethereum_trades') }} dexs
...
FROM dexs
    ...
    LEFT JOIN {{ source('balancer_v2_ethereum', 'bpt_prices') }} bpa_bpt_prices
    ...
    LEFT JOIN {{ source('balancer_v2_ethereum', 'bpt_prices') }} bpb_bpt_prices
