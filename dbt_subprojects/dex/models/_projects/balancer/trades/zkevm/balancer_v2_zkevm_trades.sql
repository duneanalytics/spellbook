...
WITH
    ...
    dexs AS (
        SELECT
            ...
            dexs_base.pool_type
        FROM {{ ref('dex_zkevm_trades') }} dexs
    ...
    bpa AS (
        ...
        FROM dexs
            LEFT JOIN {{ source('balancer_v2_zkevm', 'bpt_prices') }} bpt_prices
...
FROM dexs
    ...
    LEFT JOIN {{ source('balancer_v2_zkevm', 'bpt_prices') }} bpa_bpt_prices
    ...
    LEFT JOIN {{ source('balancer_v2_zkevm', 'bpt_prices') }} bpb_bpt_prices
