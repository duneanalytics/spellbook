{{ config(
    schema = 'sushiswap_mantle',
    alias = 'sushiswap_agg_mantle_trades',
    ...
    tags = ['mantle','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x78c1b0C915c4FAA5FffA6CAbf0219DA63d7f4cb8
