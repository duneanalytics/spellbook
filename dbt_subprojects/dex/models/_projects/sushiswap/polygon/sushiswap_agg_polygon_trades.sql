{{ config(
    ...
    alias = 'sushiswap_agg_polygon_trades',
    ...
    tags = ['polygon','sushiswap','trades','dex','aggregator'],
...
{% 
   set fns = [
     ...
     'routeprocessor3_1_call_processRoute',
...
{% set version_map = {
  ...
  'routeprocessor3_1_call_processRoute': '3',
