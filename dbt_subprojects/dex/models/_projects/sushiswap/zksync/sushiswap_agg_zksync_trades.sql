{{ config(
    schema = 'sushiswap_zksync',
    alias = 'sushiswap_agg_zksync_trades',
    ...
    tags = ['zksync','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x5AEa5775959fBC2557Cc8789bC1bf90A239D9a91
