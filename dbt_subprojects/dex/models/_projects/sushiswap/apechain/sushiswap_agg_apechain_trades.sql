{{ config(
    schema = 'sushiswap_apechain',
    alias = 'sushiswap_agg_apechain_trades',
    ...
    tags = ['apechain','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x48b62137edfa95a428d35c09e44256a739f6b557
...
price_data AS (
  ...
  LEFT JOIN {{ source('prices','usd') }} p_sold
    ...
    AND p_sold.blockchain = 'apechain'
