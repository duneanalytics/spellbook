{{ config(
    schema = 'sushiswap_scroll',
    alias = 'sushiswap_agg_scroll_trades',
    ...
    tags = ['scroll','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x5300000000000000000000000000000000000004
