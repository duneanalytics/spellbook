{{ config(
    schema = 'sushiswap_zkevm',
    alias = 'sushiswap_agg_zkevm_trades',
    ...
    tags = ['zkevm','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x4F9A0e7FD2Bf6067db6994CF12E4495Df938E6e9
