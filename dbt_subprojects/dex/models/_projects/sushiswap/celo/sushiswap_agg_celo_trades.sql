{{ config(
    ...
    alias = 'sushiswap_agg_celo_trades',
    ...
    tags = ['celo','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x471EcE3750Da237f93B8E339c536989b8978a438
