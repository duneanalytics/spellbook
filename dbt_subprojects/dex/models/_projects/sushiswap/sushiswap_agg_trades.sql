{{ config(
        ...
        alias = 'trades',
        materialized = 'view',
        post_hook='{{ expose_spells(blockchains = \'["arbitrum", "avalanche_c", "apechain", "base", "blast", "bnb", "celo", "ethereum", "fantom", "gnosis", "linea", "mantle", "nova", "optimism", "polygon", "scroll", "sonic", "zkevm", "zksync"]\',
                                    spell_type = "project",
