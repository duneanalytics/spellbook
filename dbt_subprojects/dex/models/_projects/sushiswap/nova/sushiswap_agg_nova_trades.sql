{{ config(
    ...
    alias = 'sushiswap_agg_nova_trades',
    ...
    tags = ['nova','sushiswap','trades','dex','aggregator'],
    incremental_predicates = [ incremental_predicate('call_block_time') ]
) }}

{% 
   set fns = [
     'routeprocessor_call_processRoute',
     'routeprocessor_call_transferValueAndprocessRoute',
     'routeprocessor2_call_processRoute',
     'routeprocessor2_call_transferValueAndprocessRoute',
     'routeprocessor3_call_processRoute',
     'routeprocessor3_call_transferValueAndprocessRoute',
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x722E8BdD2ce80A4422E880164f2079488e115365
