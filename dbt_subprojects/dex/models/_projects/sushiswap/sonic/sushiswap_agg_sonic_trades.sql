{{ config(
    schema = 'sushiswap_sonic',
    alias = 'sushiswap_agg_sonic_trades',
    ...
    tags = ['sonic','sushiswap','trades','dex','aggregator'],
  ...
  SELECT
    *,
    CASE
      ...
      THEN 0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38
