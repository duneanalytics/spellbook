{{ config(
    schema = 'bebop_blend_avalanche_c',
    alias = 'trades',
...
raw_call_data AS (
    ...
    FROM (
        ...
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleSingle') }}
        UNION ALL
        SELECT
            'Single' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleSingleAndSignPermit') }}
        UNION ALL
        SELECT
            'Single' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleSingleAndSignPermit2') }}
        UNION ALL
        SELECT
            'Single' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_swapSingle') }}
        UNION ALL
        SELECT
            'Single' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_swapSingleFromContract') }}
        UNION ALL
        SELECT
            'Multi' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleMulti') }}
        UNION ALL
        SELECT
            'Multi' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleMultiAndSignPermit') }}
        UNION ALL
        SELECT
            'Multi' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleMultiAndSignPermit2') }}
        UNION ALL
        SELECT
            'Multi' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_swapMulti') }}
        UNION ALL
        SELECT
            'Aggregate' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleAggregate') }}
        UNION ALL
        SELECT
            'Aggregate' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleAggregateAndSignPermit') }}
        UNION ALL
        SELECT
            'Aggregate' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_settleAggregateAndSignPermit2') }}
        UNION ALL
        SELECT
            'Aggregate' as fun_type, call_success, call_block_time, call_block_number, call_tx_hash, contract_address, "order"
        FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_call_swapAggregate') }}
    )
...
raw_call_and_event_data AS (
    ...
    FROM
        (SELECT
         ...
         FROM {{ source('bebop_pmms_avalanche_c', 'BebopSettlement_evt_BebopOrder') }}
         {% if is_incremental() %}
