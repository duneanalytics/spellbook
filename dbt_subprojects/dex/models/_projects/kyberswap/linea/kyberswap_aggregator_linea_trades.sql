...
(
    ...
    schema = 'kyberswap_aggregator_linea',
    alias = 'trades',
...
{% set project_start_date = '2023-07-17' %}
...
(
        ...
        FROM
            {{ source('kyber_linea', 'MetaAggregationRouterV2_evt_Swapped') }}
        {% if is_incremental() %}
