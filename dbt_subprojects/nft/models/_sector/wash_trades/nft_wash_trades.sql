{{ config(
        ...
        post_hook='{{ expose_spells(\'["arbitrum", "avalanche_c", "bnb", "ethereum", "gnosis", "optimism", "polygon", "celo", "zksync", "base", "scroll", "zora", "blast", "fantom", "ronin", "nova", "linea"]\',
                                    "sector",
                                    "nft",
                                    \'["hildobby"]\') }}')
}}
...
, ref('nft_fantom_wash_trades')
, ref('nft_nova_wash_trades')
