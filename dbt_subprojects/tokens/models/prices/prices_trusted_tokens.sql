...
FROM (VALUES ('arbitrum', 'USDC.e', 0xff970a61a04b1ca14834a43f5de4533ebddb5cc8),
             ...
             ('celo', 'USD₮', 0x48065fbbe25f71c9282ddf5e1cd6d6a887483d5e),
             ...
             ('fantom', 'USDC', 0x28a92dde19d9989f39a49905d7c9c2fac7799bdf),
             ...
             ('gnosis', 'wstETH', 0x6c76971f98945ae98dd7d4dfca8711ebea946ea6),
             ...
             ('linea', 'wstETH', 0xb5bedd42000b71fdde22d3ee8a79bd49a568fc8f),
             ...
             ('mantle', 'MNT', 0xdeaddeaddeaddeaddeaddeaddeaddeaddead0000),
             ('mantle', 'JOE', 0x371c7ec6d8039ff7933a2aa28eb827ffe1f52f07),
             ...
             ('optimism', 'WLD', 0xdc6ff44d5d932cbd77b52e5612ba0529dc6226f1),
             ...
             ('scroll', 'USDT', 0xf55bec9cafdbe8730f096aa55dad6d22d44099df),
             ('scroll', 'WBTC', 0x3c1bca5a656e69edcd0d4e36bebb3fcdaca60cf1),
             ('scroll', 'wstETH', 0xf610a9dfb7c89644979b4a0f27063e9e7d7cda32),
             ('solana', 'SOL', from_base58('So11111111111111111111111111111111111111112')),
             ('solana', 'mSOL', from_base58('mSoLzYCxHdYgdzU16g5QSh3i5K3z3KZK7ytfqcJm7So')),
             ('solana', 'USDT', from_base58('Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB')),
             ('solana', 'USDC', from_base58('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v')),
             ('zkevm', 'WETH', 0x4f9a0e7fd2bf6067db6994cf12e4495df938e6e9),
             ('zkevm', 'USDT', 0x1e4a5963abfd975d8c9021ce480b42188849d41d),
             ('zkevm', 'USDC', 0x37eaa0ef3549a5bb7d431be78a3d99bd360d19e5),
             ('zkevm', 'MATIC', 0xa2036f0538221a77a3937f1379699f44945018d0),
