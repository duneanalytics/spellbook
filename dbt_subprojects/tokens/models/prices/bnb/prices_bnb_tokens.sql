...
(
    ...
    ('dex-dexira', 'bnb', 'DEX', 0x147e07976e1ae78287c33aafaab87760d32e50a5, 9),
    ...
    ('zel-zelcash', 'bnb', 'bFLUX', 0x1ab6478b47270ff05af11a012ac17b098758e193, 18),
    ('zil-zilliqa', 'bnb', 'ZIL', 0xb86abcb37c3a4b64f74f59301aff131a1becc787, 12),
    ('znn-zenon', 'bnb', 'wZNN', 0x84b174628911896a3b87fa6980d05dbc2ee74836, 8),
    ...
    ('gst-gunstar-metaverse', 'bnb', 'GST', 0x4a2c860cec6471b9f5f5a336eb4f38bb21683c98, 8),
    ...
    ('usdp-paxos-standard-token', 'bnb', 'PAX', 0xb7f8cd00c5a06c0537e2abff0b58033d02e5e094,18),
    ...
    ('aaplon-apple-tokenized-stock-ondo', 'bnb', 'AAPLon', 0x390a684ef9cade28a7ad0dfa61ab1eb3842618c4, 18),
    ('amdon-amd-tokenized-stock-ondo', 'bnb', 'AMDon', 0x9f16e46c73b43bdb70861247d537bee4ea18f639, 18),
    ('amznon-amazon-tokenized-stock-ondo', 'bnb', 'AMZNon', 0x4553cfe1c09f37f38b12dc509f676964e392f8fc, 18),
    ('asmlon-asml-holding-nv-tokenized-stock-ondo', 'bnb', 'ASMLon', 0xb034f6cb52b7f2fd5a7eeeffca6b9adcd6b9a6f6, 18),
    ('avgoon-broadcom-tokenized-stock-ondo', 'bnb', 'AVGOon', 0x0ed2e3180edf393e6bf8db124bd15ddd54de150a, 18),
    ('babaon-alibaba-tokenized-stock-ondo', 'bnb', 'BABAon', 0xd5964f3fcee8d649995ab88f04b8982539c282d2, 18),
    ('coinon-coinbase-tokenized-stock-ondo', 'bnb', 'COINon', 0xf8589b526fdd65f7f301c605a6e04f0f1b4b3620, 18),
    ('crclon-circle-internet-group-tokenized-stock-ondo', 'bnb', 'CRCLon', 0x992879cd8ce0c312d98648875b5a8d6d042cbf34, 18),
    ('cscoon-cisco-systems-tokenized-stock-ondo', 'bnb', 'CSCOon', 0x34304f2f7cc487eb4186e6d69f5905a613474aa2, 18),
    ('futuon-futu-holdings-tokenized-stock-ondo', 'bnb', 'FUTUon', 0x5acf40056ed51c8bbcd1b125ef803581ac89a627, 18),
    ('gmeon-gamestop-tokenized-stock-ondo', 'bnb', 'GMEon', 0xdabb9aff4cf02f26d2014e4ca9f94ac6fe6572a3, 18),
    ('googlon-alphabet-class-a-tokenized-stock-ondo', 'bnb', 'GOOGLon', 0x091fc7778e6932d4009b087b191d1ee3bac5729a, 18),
    ('hoodon-robinhood-markets-tokenized-stock-ondo', 'bnb', 'HOODon', 0x19601179a60f55ff6636f5d1a8b6671053bd60a8, 18),
    ...
    ('mstron-microstrategy-tokenized-stock-ondo', 'bnb', 'MSTRon', 0x7313ea16493b2f55054df0131a3a14b043ec8992, 18),
    ('muon-micron-technology-tokenized-stock-ondo', 'bnb', 'MUon', 0x8b6acf6041a81567f012ff6a4c6d96d5818d74bf, 18),
    ('nflxon-netflix-tokenized-stock-ondo', 'bnb', 'NFLXon', 0x7048f5227b032326cc8dbc53cf3fddd947a2c757, 18),
    ('nvdaon-nvidia-tokenized-stock-ondo', 'bnb', 'NVDAon', 0xa9ee28c80f960b889dfbd1902055218cba016f75, 18),
    ('orclon-oracle-tokenized-stock-ondo', 'bnb', 'ORCLon', 0x03e4bd1ea53f1da84513da0319d1f03dd1bbcf93, 18),
    ('pltron-palantir-technologies-tokenized-stock-ondo', 'bnb', 'PLTRon', 0x9351abd19f42101dd36025e495b98e910b255d78, 18),
    ('qqqon-invesco-qqq-tokenized-etf-ondo', 'bnb', 'QQQon', 0x0cde6936d305d5b34667fc46425e852efd73559a, 18),
    ('rddton-reddit-tokenized-stock-ondo', 'bnb', 'RDDTon', 0x4da12f47578ef89c76179b760c778e70b668f80b, 18),
    ('slvon-ishares-silver-trust-tokenized-etf-ondo', 'bnb', 'SLVon', 0x8b872732b07be325a8803cdb480d9d20b6f8d11b, 18),
    ('spyon-spdr-sp-500-tokenized-etf-ondo', 'bnb', 'SPYon', 0x6a708ead771238919d85930b5a0f10454e1c331a, 18),
    ('tslaon-tesla-tokenized-stock-ondo', 'bnb', 'TSLAon', 0x2494b603319d4d9f9715c9f4496d9e0364b59d93, 18),
    ('unhon-unitedhealth-tokenized-stock-ondo', 'bnb', 'UNHon', 0x3385cb29cca0ac66f5d2354d13ef977b49a2510f, 18),
    ('xomon-exxon-mobil-tokenized-stock-ondo', 'bnb', 'XOMon', 0x4d209d275e3492ac08497a7a42915899c4dd5e86, 18),
    --Tokenized Equities (xStock)
    ('aaplx-apple-tokenized-stock-xstock', 'bnb', 'AAPLx', 0x9d275685dc284c8eb1c79f6aba7a63dc75ec890a, 18),
    ('amznx-amazon-tokenized-stock-xstock', 'bnb', 'AMZNx', 0x3557ba345b01efa20a1bddc61f573bfd87195081, 18),
    ('coinx-coinbase-tokenized-stock-xstock', 'bnb', 'COINx', 0x364f210f430ec2448fc68a49203040f6124096f0, 18),
    ('crclx-circle-tokenized-stock-xstock', 'bnb', 'CRCLx', 0xfebded1b0986a8ee107f5ab1a1c5a813491deceb, 18),
    ('googlx-alphabet-tokenized-stock-xstock', 'bnb', 'GOOGLx', 0xe92f673ca36c5e2efd2de7628f815f84807e803f, 18),
    ('hoodx-robinhood-tokenized-stock-xstock', 'bnb', 'HOODx', 0xe1385fdd5ffb10081cd52c56584f25efa9084015, 18),
    ('mcdx-mcdonalds-tokenized-stock-xstock', 'bnb', 'MCDx', 0x80a77a372c1e12accda84299492f404902e2da67, 18),
    ('metax-meta-tokenized-stock-xstock', 'bnb', 'METAx', 0x96702be57cd9777f835117a809c7124fe4ec989a, 18),
    ...
    ('ivvon-ishares-core-sampp-500-tokenized-etf-ondo', 'bnb', 'IVVon', 0x1104eb7e85e25eb45f88e638b0c27a06c1a91cb2, 18),
    ('iwfon-ishares-russell-1000-growth-tokenized-etf-ondo', 'bnb', 'IWFon', 0x40755f06ab7f8de1ab3a9413b1ef562d63de19b1, 18),
    ('iwnon-ishares-russell-2000-value-tokenized-etf-ondo', 'bnb', 'IWNon', 0xf54b94ea21e1da5d51ef00fd4502225e5394f874, 18),
    ('klacon-kla-tokenized-stock-ondo', 'bnb', 'KLACon', 0xfc263946439b0d802bf4c5a6fcd34e2885259f91, 18),
    ('kwebon-kraneshares-csi-china-internet-tokenized-etf-ondo', 'bnb', 'KWEBon', 0x7437203800140ba7d9081dde8cef09ee40e3bf03, 18),
    ('linon-linde-plc-tokenized-stock-ondo', 'bnb', 'LINon', 0xe1743616f705954620aa351465c8885fbde5a8a9, 18),
    ('lunron-intuitive-machines-tokenized-stock-ondo', 'bnb', 'LUNRon', 0xa3b7b7cfeb023a6c4f444f5ca9a3fc85809ece15, 18),
    ('mpon-mp-materials-tokenized-stock-ondo', 'bnb', 'MPon', 0x4baf4dc56cf6a525a0874e25cc6372a6a8915135, 18),
    ('mrvlon-marvell-technology-tokenized-stock-ondo', 'bnb', 'MRVLon', 0x1501ec83ffef405b4331cc4f73277a40fb0c627d, 18),
    ('neeon-nextera-energy-ondo-tokenized', 'bnb', 'NEEon', 0xe9d43f7e6b2237e8873a7003b3f43c6b03160be5, 18),
    ('nemon-newmont-tokenized-stock-ondo', 'bnb', 'NEMon', 0x5e63232993789601ce362e0240a299c1dfcbfbec, 18),
    ('nioon-nio-tokenized-stock-ondo', 'bnb', 'NIOon', 0xc6f9edbee6042a237d72493bbda3ee2c3c62f708, 18),
    ('nocon-northrop-grumman-tokenized-stock-ondo', 'bnb', 'NOCon', 0x4d3442d884202584f1729bca20db05472b886b52, 18),
    ('nowon-servicenow-tokenized-stock-ondo', 'bnb', 'NOWon', 0xeb19c13c54b1cd48afc62f6503375e92d5f1e856, 18),
    ('nvoon-novo-nordisk-tokenized-stock-ondo', 'bnb', 'NVOon', 0x08a513779f46ffb7a34f16094a94016d010128a8, 18),
    ('okloon-oklo-tokenized-stock-ondo', 'bnb', 'OKLOon', 0xaf6c03acf72355ce98d0741302b78870b376428c, 18),
    ('ondson-ondas-holdings-tokenized-stock-ondo', 'bnb', 'ONDSon', 0xd85d4ce29b4ca361ff72ef0e53d6236e334c5db6, 18),
    ('oscron-oscar-health-tokenized-stock-ondo', 'bnb', 'OSCRon', 0xb0752aa50b089ee6ea9acd51373207fa460e87bb, 18),
    ('oxyon-occidental-petroleum-tokenized-stock-ondo', 'bnb', 'OXYon', 0x01b5a4ac600be98448dbefbb78bcdf38262552cc, 18),
    ('panwon-palo-alto-networks-tokenized-stock-ondo', 'bnb', 'PANWon', 0x0eaa1a75bd682a5669ab2371a559fbd039c6b9eb, 18),
    ('paveon-global-x-us-infrastructure-development-tokenized-etf-ondo', 'bnb', 'PAVEon', 0x6f28cb07790c1049ecd7482d09fd13b977b47201, 18),
    ('pddon-pdd-holdings-tokenized-stock-ondo', 'bnb', 'PDDon', 0xf3e82ea164cb344b2b11bad4c24b0ea4f7ba4714, 18),
    ('pgon-procter-amp-gamble-tokenized-stock-ondo', 'bnb', 'PGon', 0x400f1e257f86d25578a0928c94dc95115f09d5c9, 18),
    ('plugon-plug-power-tokenized-stock-ondo', 'bnb', 'PLUGon', 0x4752ae8f910b25e64e4406eaad50c1b4e8de7e6d, 18),
    ('pplton-abrdn-physical-platinum-shares-tokenized-etf-ondo', 'bnb', 'PPLTon', 0x3ec23f52f6573fc0587a0631dd8c3b107f6bcb35, 18),
    ('psqon-proshares-short-qqq-tokenized-stock-ondo', 'bnb', 'PSQon', 0x3802dc739ef9e226f36421a9c15efa519153bbbe, 18),
    ('qubton-quantum-computing-tokenized-stock-ondo', 'bnb', 'QUBTon', 0x82e07c1017032cfd889b1ca81ebe722c4d4de825, 18),
    ('rdwon-redwire-tokenized-stock-ondo', 'bnb', 'RDWon', 0x23e39d94807a8bb7e3f8294b4911d04ee26dce39, 18),
    ('regnon-regeneron-pharmaceuticals-tokenized-stock-ondo', 'bnb', 'REGNon', 0x30bd85fd4286c5c9857679f5b188f737b4a7b8c0, 18),
    ('remxon-vaneck-rare-earth-and-strategic-metals-tokenized-etf-ondo', 'bnb', 'REMXon', 0xc16f47c4a7ed39372b9a0e3e2016cede9b4cb83a, 18),
    ('rgtion-rigetti-computing-tokenized-stock-ondo', 'bnb', 'RGTIon', 0xed2a500eb2b66679e0bbd76e51a60049ae5f3271, 18),
    ('rivnon-rivian-automotive-tokenized-stock-ondo', 'bnb', 'RIVNon', 0x277e1fa8704c5511fed7e30bc691f922aa30101b, 18),
    ('rtxon-rtx-tokenized-stock-ondo', 'bnb', 'RTXon', 0x44fde2c6bc2c2b54962c69fcef57a2a50121dbd7, 18),
    ('sbuxon-starbucks-tokenized-stock-ondo', 'bnb', 'SBUXon', 0x94d7754541b829a87321d56121bc544167ac490d, 18),
    ('sccoon-southern-copper-tokenized-stock-ondo', 'bnb', 'SCCOon', 0xf15b8f7465b92799f6ee440f86b3cab5a4dbc65a, 18),
    ('sgovon-ishares-0-3-month-treasury-bond-etf-ondo-tokenized-etf', 'bnb', 'SGOVon', 0xc008c5f579ec1450f20099c39f587547e27c7523, 18),
    ('smcion-super-micro-computer-tokenized-stock-ondo', 'bnb', 'SMCIon', 0xc142ba8ccd36d80c3a001342fb83e4c3d218a873, 18),
    ('sofion-sofi-technologies-tokenized-stock-ondo', 'bnb', 'SOFIon', 0x71507068e98049cba81e9bbc8d901e4a2f4222eb, 18),
    ('soxxon-ishares-semiconductor-tokenized-etf-ondo', 'bnb', 'SOXXon', 0x2a3cbf64c8181db4a25d41d4d7a7db9984c59dac, 18),
    ('sqqqon-proshares-ultrapro-short-qqq-tokenized-stock-ondo', 'bnb', 'SQQQon', 0x17515b68378d86c38f394c666e79907da05dcba9, 18),
    ('stxon-seagate-tokenized-stock-ondo', 'bnb', 'STXon', 0x966ebcba3c51e81f5cf159a1eabefd2327ab5e8d, 18),
    ('tcomon-tripcom-group-tokenized-stock-ondo', 'bnb', 'TCOMon', 0x6459303f58244ff1e7a42b90aa3782dfb6ca6969, 18),
    ('tipon-ishares-tips-bond-tokenized-etf-ondo', 'bnb', 'TIPon', 0x2ac26ec236df5d1d2ad1a6dd4e448a90e45dc35d, 18),
    ('tmuson-t-mobile-us-tokenized-stock-ondo', 'bnb', 'TMUSon', 0x2588f20bad92da8dcce7fac8311b5f8ab4690e43, 18),
    ('tqqqon-proshares-ultrapro-qqq-tokenized-stock-ondo', 'bnb', 'TQQQon', 0xe42cfb20e00912409b77a602b5bdcff3c7acc5f4, 18),
    ('uecon-uranium-energy-tokenized-stock-ondo', 'bnb', 'UECon', 0xe7ddf606841ee278a30e5c90486681e68ddd8cbf, 18),
    ('ungon-us-natural-gas-fund-tokenized-stock-ondo', 'bnb', 'UNGon', 0xa5351c9bf08055e03642b6b8649a0f7e895501bf, 18),
    ('unpon-union-pacific-corporation-tokenized-stock-ondo', 'bnb', 'UNPon', 0xfe9aa194e3c4604f3872f220eb41c33a287fcd90, 18),
    ('uraon-global-x-uranium-tokenized-etf-ondo', 'bnb', 'URAon', 0xc7806943663158d68740a14ab0b270bd60bde87d, 18),
    ('usfron-wisdomtree-floating-rate-treasury-fund-ondo-tokenized', 'bnb', 'USFRon', 0xf4fd75764a5c086fb12f822be2ca318b3a362dc3, 18),
    ('usoon-united-states-oil-tokenized-fund-ondo', 'bnb', 'USOon', 0x94174e3d1335db402dd03a092f7aa7ac2cb32be4, 18),
    ('vrton-vertiv-tokenized-stock-ondo', 'bnb', 'VRTon', 0x9cea8a7be1ab0320b709d368ad60d8500f55995f, 18),
    ('vrtxon-vertex-pharmaceuticals-tokenized-stock-ondo', 'bnb', 'VRTXon', 0x8c9979dc208f74a5602c38691aa920f121e2f863, 18),
    ('vston-vistra-tokenized-stock-ondo', 'bnb', 'VSTon', 0xf2c24c47805f4f72d3919c8674bfdd401505794b, 18),
