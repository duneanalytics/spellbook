...
cast(json_extract_scalar(_editionConfig, '$.royaltyBPS') as double)/1e4 AS royalty_pct,
...
cast(json_extract_scalar(_config, '$.royaltyBPS') as double)/1e4 AS royalty_pct,
