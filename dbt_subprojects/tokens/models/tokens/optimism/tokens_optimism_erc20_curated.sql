...
WITH raw_token_list AS (
 SELECT 
    ...
    -- Price-curated tokens that previously reached tokens.erc20 via bridge-generated metadata.
    ,(0xb4bc46bc6cb217b59ea8f4530bae26bf69f677f0, 'BEETS', 18, 'underlying')
    ,(0x1cef2d62af4cd26673c7416957cc4ec619a696a7, 'DTORO', 18, 'underlying')
    ,(0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, 'ETH', 18, 'underlying')
    ,(0x2416092f143378750bb29b79ed961ab195cceea5, 'ezETH', 18, 'underlying')
    ,(0x9923db8d7fbacc2e69e87fad19b886c81cd74979, 'HYPER', 18, 'underlying')
    ,(0xbc7b1ff1c6989f006a1185318ed4e7b5796e66e1, 'PENDLE', 18, 'underlying')
    ,(0x4186bfc76e2e237523cbc30fd220fe055156b41f, 'rsETH', 18, 'underlying')
    ,(0x7d342726b69c28d942ad8bfe6ac81b972349d524, 'SACRO', 18, 'underlying')
    ,(0x2218a117083f5b482b0bb821d27056ba9c04b1d3, 'sDAI', 18, 'underlying')
    ,(0xaf8ca653fa2772d58f4368b0a71980e9e3ceb888, 'TRB', 18, 'underlying')
    ,(0x17aabf6838a6303fc6e9c5a227dc1eb6d95c829a, 'TUX', 18, 'underlying')
    ,(0xbb586ed34974b15049a876fd5366a4c2d1203115, 'UBI', 18, 'underlying')
    ,(0x5d3a1ff2b6bab83b63cd9ad0787074081a52ef34, 'USDe', 18, 'underlying')
    ,(0xef4461891dfb3ac8572ccf7c794664a8dd927945, 'WCT', 18, 'underlying')
    ,(0x5a7facb970d094b6c7ff1df0ea68d99e6e73cbff, 'weETH', 18, 'underlying')
    ,(0x6985884c4392d348587b19cb9eaaf157f13271cd, 'ZRO', 18, 'underlying')
