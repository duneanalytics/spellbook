...
FROM (VALUES
    ...
    ('scroll', 0xca77eb3fefe3725dc33bccb54edefc3d9f764f97, 'Fiat-backed stablecoin', 'DAI', 18, ''),
    ('scroll', 0x5d3a1ff2b6bab83b63cd9ad0787074081a52ef34, 'Fiat-backed stablecoin', 'USDe', 18, ''),
    ('scroll', 0x77fbf86399ed764a084f77b9accb049f3dbc32d2, 'Fiat-backed stablecoin', 'loreUSD', 18, ''),
    ('scroll', 0xedeabc3a1e7d21fe835ffa6f83a710c70bb1a051, 'Fiat-backed stablecoin', 'LUSD', 18, ''),
