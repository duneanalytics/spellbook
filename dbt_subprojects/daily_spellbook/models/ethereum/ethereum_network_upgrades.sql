...
WITH upgrades AS (
        ...
        , (22, 'Pectra', 'Prague', 22431084, ARRAY[7702,7840,7251,7685,7549], 'Enhances account abstraction and efficiency, enabling EOAs to delegate control to smart contracts for more flexible transactions.', 'https://ethereum.org/en/roadmap/pectra', true, NULL, 6, 9)
        , (22, 'Pectra', 'Electra', 22431084, ARRAY[2537,2935,6110,7002,7623,7691], 'Validator consolidation & more', 'https://ethereum.org/en/roadmap/pectra', true, NULL, 6, 9)
        , (23, 'Fusaka', 'Fusaka', 23935694 , ARRAY[NULL], '', 'https://ethereum.org/en/roadmap/fusaka/', false, 'Planned for 2025', NULL, NULL)
