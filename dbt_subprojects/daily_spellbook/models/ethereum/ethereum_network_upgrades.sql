...
WITH upgrades AS (
        ...
        , (22, 'Pectra', 'Pectra', 22428718, ARRAY[7702,7691,7623,7840,7251,7002,7685,6110,2537,2935,7549], 'Enhances account abstraction and efficiency, enabling EOAs to delegate control to smart contracts for more flexible transactions.', 'https://ethereum.org/en/roadmap/pectra', true, NULL, 6, 9)
        , (23, 'Fusaka', 'Fusaka', -1, ARRAY[NULL], '', 'https://ethereum.org/en/roadmap/fusaka/', false, 'Planned for 2026', NULL, NULL)
