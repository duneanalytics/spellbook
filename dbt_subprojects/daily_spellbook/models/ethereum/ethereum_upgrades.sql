...
FROM (VALUES
    ...
    , (22, 'Pectra', 'Pectra', 22428718, ARRAY[7702,7691,7623,7840,7251,7002,7685,6110,2537,2935,7549], 'Upcoming execution and consensus upgrade', 'https://ethereum.org/en/roadmap/pectra', true, NULL, 6, 9)
