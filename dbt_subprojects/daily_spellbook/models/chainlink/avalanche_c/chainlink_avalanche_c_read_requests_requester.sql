...
LEFT JOIN {{ ref('chainlink_avalanche_c_read_requests_requester_meta') }} requester_addresses ON requester_addresses.requester_address = log_meta."from"
LEFT JOIN {{ ref('chainlink_avalanche_c_price_feeds_oracle_addresses') }} oracle_addresses ON oracle_addresses.proxy_address = log_meta."to"
