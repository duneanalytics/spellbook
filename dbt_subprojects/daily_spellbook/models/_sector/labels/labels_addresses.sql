...
{% set single_category_labels_models = [
    ...
    , source('labels', 'balancer_cowswap_amm_pools_arbitrum')
    , source('labels', 'balancer_cowswap_amm_pools_base')
    , source('labels', 'balancer_cowswap_amm_pools_ethereum')
    , source('labels', 'balancer_cowswap_amm_pools_gnosis')
