{{ config(
	...
	alias='users_capital_action_inbound_pusd_transfer_candidates',
...
select
	...
	, t.amount_raw
	, t.amount
	, t.amount as amount_usd -- pusd has no usd price feed yet; treat 1:1 with usdc
	, t.evt_index
	, t.tx_hash
from
	{{ source('tokens_polygon', 'transfers') }} as t
where
	t.contract_address = 0xc011a7e12a19f7b1f670d46f03b03f3342e82dfb -- pusd (v2 collateral; 1:1 usdc-backed)
	and exists (
		select
			1
		from
