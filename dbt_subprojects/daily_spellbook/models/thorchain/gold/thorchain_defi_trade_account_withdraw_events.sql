{{ config(
    schema = 'thorchain',
    alias = 'defi_trade_account_withdraw_events',
    ...
    tags = ['thorchain', 'defi', 'trade_account_withdraw_events', 'fact'],
    post_hook='{{ expose_spells(\'["thorchain"]\',
                              "defi",
                              "defi_trade_account_withdraw_events",
                              \'["krishhh"]\') }}'
) }}
...
WITH deduplicated AS (
    ...
    FROM {{ source('thorchain', 'trade_account_withdraw_events') }}
