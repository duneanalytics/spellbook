...
FROM (
        ...
        , (2741, 'abstract', 'Abstract', 'Layer 2', 'Optimistic Rollup', 'ETH', 0x000000000000000000000000000000000000800a, 'https://abscan.org/', timestamp '2024-10-25 06:31:23', 'OP Stack', 'Ethereum Blobs', 'Ethereum', true)
