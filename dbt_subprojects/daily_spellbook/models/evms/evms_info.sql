...
FROM (
        ...
        , (360, 'shape', 'Shape', 'Layer 2', 'Optimistic Rollup', 'ETH', 0x4200000000000000000000000000000000000006, 'https://shapescan.xyz/', timestamp '2024-07-23 22:21:13', 'OP Stack', 'Ethereum Blobs', 'Ethereum', false)
