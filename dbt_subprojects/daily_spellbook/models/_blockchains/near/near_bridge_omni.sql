...
inbound_omni AS (
    ...
    SELECT
        ...
        has_mint,
        FALSE AS has_burn,
        CAST(json_extract_scalar(event_json, '$.FinTransferEvent.transfer_message.amount') AS DECIMAL(38,0)) AS amount_raw,
        ...
        CAST(json_extract_scalar(event_json, '$.FinTransferEvent.transfer_message.origin_nonce') AS BIGINT) AS origin_nonce,
        CAST(json_extract_scalar(event_json, '$.FinTransferEvent.transfer_message.destination_nonce') AS BIGINT) AS destination_nonce,
...
outbound_omni AS (
    ...
    SELECT
        ...
        FALSE AS has_mint,
        has_burn,
        CAST(json_extract_scalar(event_json, '$.InitTransferEvent.transfer_message.amount') AS DECIMAL(38,0)) AS amount_raw,
        ...
        CAST(json_extract_scalar(event_json, '$.InitTransferEvent.transfer_message.origin_nonce') AS BIGINT) AS origin_nonce,
        CAST(json_extract_scalar(event_json, '$.InitTransferEvent.transfer_message.destination_nonce') AS BIGINT) AS destination_nonce,
