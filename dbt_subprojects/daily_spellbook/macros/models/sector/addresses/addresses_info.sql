...
, GREATEST(GREATEST(last_sent_block_time, last_received_block_time), last_tx_block_time) AS last_seen
FROM executed_txs
...
, GREATEST(COALESCE(nd.last_transfer_block_time, t.last_transfer_block_time), COALESCE(nd.last_tx_block_time, t.last_tx_block_time)) AS last_seen
FROM new_data nd
