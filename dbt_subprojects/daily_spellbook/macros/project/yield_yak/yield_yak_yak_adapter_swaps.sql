{%- macro yield_yak_yak_adapter_swaps(
        blockchain = null
    )
-%}
...
basic_yak_swaps AS (
    SELECT
        ...
        , s._tokenIn AS token_in_address
        , s._tokenOut AS token_out_address
        , s._amountIn AS amount_in
        , s._amountOut AS amount_out
...
SELECT
    ...
    , s.trader_address
    , s.token_in_address AS swap_token_in_address
    , s.token_out_address AS swap_token_out_address
    , s.amount_in AS swap_amount_in
