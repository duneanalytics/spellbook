...
{% set 
    config = [
        ...
        , ('0x111111125421ca6dc452d289314280a0f8842a65', 'true', '1inch'                , 'AggregationRouterV6'     , ['ethereum','bnb','polygon','arbitrum','avalanche_c','gnosis','optimism','fantom','base','linea','sonic','unichain','monad'])
        ...
        , ('0x65497e56cf49c51f1c1d54dc9005a7b38b98b30f', 'true', '1inch'                , 'SettlementV3v1'          , ['monad','hyperevm'])
        ...
        , ('0xbbbbbBB520d69a9775E85b458C58c648259FAD5F', 'true', 'Bebop'                , 'BebopSettlement'         , ['ethereum','arbitrum','base','optimism','hyperevm'])
        ...
        , ('0xb300000b72DEAEb607a12d5f54773D1C19c7028d', 'true', 'Binance'              , 'DEXRouter'               , ['ethereum','bnb','polygon','arbitrum','avalanche_c','base','optimism','fantom','gnosis','monad'])
        ...
        , ('0x663dc15d3c1ac63ff12e45ab68fea3f0a883c251', 'true', 'Debridge'             , 'CrosschainProxy'         , ['ethereum','bnb','polygon','optimism','arbitrum','avalanche_c','gnosis','base','linea','monad','hyperevm'])
        ...
        , ('0x6131b5fae19ea4f9d964eac0408e4408b66337b5', 'true', 'Kyber'                , 'MetaAggregationRouterV2' , ['ethereum','bnb','polygon','arbitrum','avalanche_c','optimism','fantom','base','linea','sonic','unichain','monad','hyperevm'])
        ...
        , ('0x1231deb6f5749ef6ce6943a275a1d3e7486f4eae', 'true', 'LiFi'                 , 'DiamondV2'               , ['ethereum','bnb','polygon','arbitrum','avalanche_c','gnosis','optimism','fantom','base','sonic'])
        ...
        , ('0x013bb8a204499523ddf717e0abaa14e6dc849060', 'true', 'Maestro'              , 'MaestroSniperBot'        , ['base','bnb','monad','hyperevm'])
        ...
        , ('0x6352a56caadc4f1e25cd6c75970fa768a3304e64', 'true', 'OpenOcean'            , 'ExchangeV2'              , ['ethereum','bnb','polygon','avalanche_c','optimism','fantom','base','arbitrum','gnosis','linea','unichain','sonic','monad','hyperevm'])
        ...
        , ('0x13f4ea83d0bd40e75c8222255bc855a974568dd4', 'true', 'PancakeSwap'          , 'SmartRouter'             , ['ethereum','bnb','monad'])
        ...
        , ('0x00000000009726632680fb29d3f7a9734e3010e2', 'true', 'Rainbow'              , 'RainbowRouter'           , ['ethereum','monad','hyperevm'])
        ...
        , ('0x4c4AF8DBc524681930a27b2F1Af5bcC8062E6fB7', 'true', 'WooFi'                , 'WooRouterV2'             , ['arbitrum','avalanche_c','base','bnb','ethereum','linea','mantle','optimism','polygon','fantom','monad','hyperevm'])
