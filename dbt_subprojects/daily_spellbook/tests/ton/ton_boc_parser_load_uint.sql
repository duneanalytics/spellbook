WITH test_data AS (
    SELECT boc, CAST(expected AS ROW(uint8 bigint, uint1 bigint, uint32 bigint, uint64 varchar, uint128 varchar, uint256 varchar)) AS expected, offset
    FROM (
        VALUES
        -- all zeroes
        (
        ...
        (
            ...
            ROW(255, 1, 4294967295, '18446744073709551615', '340282366920938463463374607431768211455', '115792089237316195423570985008687907853269984665640564039457584007913129639935'),
            0
        ),
        -- -- random values
        (
            ...
            ROW(173, 1, 168009204, '9284579784594529233', '327885090305647464340472349599389424070', '42430022509486004761842093696456834131842743534333780353852533344986326118836'),
            0
        ),
