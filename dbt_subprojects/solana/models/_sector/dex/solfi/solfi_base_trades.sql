...
select
  ...
  case when direction = 'AtoB' then account_userTokenAccountA else account_userTokenAccountB end as token_sold_mint_address,
  case when direction = 'AtoB' then account_userTokenAccountB else account_userTokenAccountA end as token_bought_mint_address,
  case when direction = 'AtoB' then account_poolTokenAccountA else account_poolTokenAccountB end as token_sold_vault,
  case when direction = 'AtoB' then account_poolTokenAccountB else account_poolTokenAccountA end as token_bought_vault,
