...
, all_swaps as (
    ...
    INNER JOIN transfers as trs_1
        ...
        AND trs_1.from_owner != '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1' --raydium pool v4 authority
    INNER JOIN transfers as trs_2
        ...
        AND trs_2.from_owner = '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1' --raydium pool v4 authority
)
