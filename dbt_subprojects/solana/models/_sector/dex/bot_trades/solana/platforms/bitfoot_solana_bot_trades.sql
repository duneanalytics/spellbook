...
{% set project_start_date = '2024-11-21' %}
{% set fee_receiver_1 = 'BzmpLvrhZHKoXV7CW9F1AVPnie3hNh2JK3BRdHL4Zcya' %}
...
WITH
  allFeePayments AS (
    ...
    WHERE
      ...
      AND address_prefix = '{{ fee_receiver_1[:2] }}'
  ),
  botTrades AS (
    SELECT
      trades.block_time,
