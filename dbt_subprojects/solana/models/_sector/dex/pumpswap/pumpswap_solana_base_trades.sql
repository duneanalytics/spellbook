...
, swaps_with_transfers AS (
    ...
    INNER JOIN {{ ref('tokens_solana_transfers') }} t
        ...
        AND (
                ...
                AND t.inner_instruction_index IN (1, 2, 3, 6, 7) 
            ...
            OR
                ...
                AND t.inner_instruction_index IN (sf.swap_inner_index + 1, sf.swap_inner_index + 2, sf.swap_inner_index + 3, sf.swap_inner_index + 6, sf.swap_inner_index + 7) 
                AND (t.from_token_account = sf.account_user_quote_token_account OR t.from_token_account = sf.account_pool_quote_token_account)
                )
            )
