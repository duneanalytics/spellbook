...
{%- set models = [
    ...
    'gas_solana_tx_fees_2024_q4' -- this currently has current_date as end_date, if we ever need to backfill further we will need to update this
] -%}
