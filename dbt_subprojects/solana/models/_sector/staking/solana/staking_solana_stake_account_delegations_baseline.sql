-- TEMPORARY: identical copy of the pre-PR-9685 staking_solana_stake_account_delegations
-- model. Exists solely so CI builds it side-by-side with the optimized version,
-- enabling a same-source-data comparison to rule out source drift. To be removed
-- before merge.
{{ config(
    schema = 'staking_solana'
    , alias = 'stake_account_delegations_baseline'
