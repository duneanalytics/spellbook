...
The `blast.blocks` table contains information about blocks on the blast blockchain. It includes:
...
The `blast.traces` table contains records of execution steps for transactions on the blast blockchain. Each trace represents an atomic operation that modifies the blockchain state. Key components include:
...
The `blast.contracts` table contains information about verified smart contracts on the blast blockchain. It includes:
...
{% docs blast_contracts_submitted_doc %}

The `blast.contracts_submitted` table contains information about manually submitted contract verifications on the blast blockchain. It includes:
...
The `blast.traces_decoded` table contains decoded traces with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `blast.logs_decoded` table contains decoded event logs with additional information based on submitted smart contracts and their ABIs. It includes:
