...
The `sophon.contracts` table contains information about verified smart contracts on the sophon blockchain. It includes:
...
The `sophon.contracts_submitted` table contains information about manually submitted contract verifications on the sophon blockchain. It includes:
...
The `sophon.traces_decoded` table contains decoded traces with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `sophon.logs_decoded` table contains decoded event logs with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `erc20_sophon.evt_transfer` table contains Transfer events for ERC20 tokens on the sophon blockchain. It includes:
...
This table is used for tracking ERC20 token movements on the sophon network.
...
The `erc1155_sophon.evt_TransferSingle` table contains TransferSingle events for ERC1155 tokens on the sophon blockchain. It includes:
...
This table is used for tracking individual ERC1155 token transfers on the sophon network.
...
The `erc1155_sophon.evt_TransferBatch` table contains TransferBatch events for ERC1155 tokens on the sophon blockchain. It includes:
...
This table is used for tracking batch transfers of multiple ERC1155 tokens on the sophon network.
...
The `erc721_sophon.evt_Transfer` table contains Transfer events for ERC721 tokens on the sophon blockchain. It includes:
...
This table is used for tracking ERC721 token (NFT) transfers on the sophon network.
