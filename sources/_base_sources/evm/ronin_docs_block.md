...
The `ronin.blocks` table contains information about blocks on the ronin blockchain. It includes:
...
The `ronin.traces` table contains records of execution steps for transactions on the ronin blockchain. Each trace represents an atomic operation that modifies the blockchain state. Key components include:
...
The `ronin.contracts` table contains information about verified smart contracts on the ronin blockchain. It includes:
...
{% docs ronin_contracts_submitted_doc %}

The `ronin.contracts_submitted` table contains information about manually submitted contract verifications on the ronin blockchain. It includes:
...
The `ronin.traces_decoded` table contains decoded traces with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `ronin.logs_decoded` table contains decoded event logs with additional information based on submitted smart contracts and their ABIs. It includes:
