...
The `arbitrum.blocks` table contains information about blocks on the arbitrum blockchain. It includes:
...
The `arbitrum.traces` table contains records of execution steps for transactions on the arbitrum blockchain. Each trace represents an atomic operation that modifies the blockchain state. Key components include:
...
The `arbitrum.contracts` table contains information about verified smart contracts on the arbitrum blockchain. It includes:
...
{% docs arbitrum_contracts_submitted_doc %}

The `arbitrum.contracts_submitted` table contains information about manually submitted contract verifications on the arbitrum blockchain. It includes:
...
The `arbitrum.traces_decoded` table contains decoded traces with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `arbitrum.logs_decoded` table contains decoded event logs with additional information based on submitted smart contracts and their ABIs. It includes:
