...
The `mantle.blocks` table contains information about blocks on the mantle blockchain. It includes:
...
The `mantle.traces` table contains records of execution steps for transactions on the mantle blockchain. Each trace represents an atomic operation that modifies the blockchain state. Key components include:
...
The `mantle.contracts` table contains information about verified smart contracts on the mantle blockchain. It includes:
...
{% docs mantle_contracts_submitted_doc %}

The `mantle.contracts_submitted` table contains information about manually submitted contract verifications on the mantle blockchain. It includes:
...
The `mantle.traces_decoded` table contains decoded traces with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `mantle.logs_decoded` table contains decoded event logs with additional information based on submitted smart contracts and their ABIs. It includes:
...
This table is used for tracking ERC20 token movements on the mantle network.
