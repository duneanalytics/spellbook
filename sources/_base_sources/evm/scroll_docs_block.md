...
The `scroll.blocks` table contains information about blocks on the scroll blockchain. It includes:
...
The `scroll.traces` table contains records of execution steps for transactions on the scroll blockchain. Each trace represents an atomic operation that modifies the blockchain state. Key components include:
...
The `scroll.contracts` table contains information about verified smart contracts on the scroll blockchain. It includes:
...
{% docs scroll_contracts_submitted_doc %}

The `scroll.contracts_submitted` table contains information about manually submitted contract verifications on the scroll blockchain. It includes:
...
The `scroll.traces_decoded` table contains decoded traces with additional information based on submitted smart contracts and their ABIs. It includes:
...
The `scroll.logs_decoded` table contains decoded event logs with additional information based on submitted smart contracts and their ABIs. It includes:
...
This table is used for tracking ERC20 token movements on the scroll network.
