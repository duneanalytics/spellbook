...
case when main_token_reserve = 5430.911417654671 then true else false end as success
...
select 'Check USDC:wstETH 0.008 pool' as test_name, 
case when paired_token_reserve = 8056414.658883 then true else false end as success
from {{ref('lido_liquidity_kyberswap_ethereum')}}
