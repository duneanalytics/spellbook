with unit_test1 as (
    ...
    where evt_tx_hash = 0x0326269a2ba51eab9601cad4de2507abbbf709c19cc897ffa2c1d0482bd5c692
...
unit_test2 as (
    ...
    from {{ ref('compound_v2_ethereum_borrow') }}
    where evt_tx_hash = 0xb1a56cee663a771eead84c4a4be15ece601c56df708b369aeacb5c271dda6699
