...
with sampled_wallets as
 (
     ...
     where wallet_address in (select distinct cast(wallet_address as varbinary) from {{ ref('balances_base_erc20_latest_entries') }})
     ...
     and bal.block_hour > cast('2023-11-04' as date) and bal.block_hour < cast('2023-11-06' as date)
 )
